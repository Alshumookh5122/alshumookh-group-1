...
function prBuildPrintHTML(type, d, meta, titleStr, ref) {
  ...
  var parts = [
    ...
    +   '<text x="70" y="75" text-anchor="middle" font-size="20" font-weight="900" fill="#e2c97e" font-family="Georgia,serif">AG</text>'
