...
_SIDEBAR_LINKS = [
    ...
    ("/dashboard/wallet-verify",  "🔐", "Wallet Verify OTP"),
    ("/dashboard/circle",         "🔵", "Circle Wire"),
...
function _prPrint(){
  ...
  var html='<!doctype html><html><head><meta charset=utf-8><title>Private Report — '+titleStr+'</title><style>'+css+'</style></head><body>'
    ...
    +'<div class="hdr"><div><div class="co">ALSHUMOOKH GLOBAL BANKING FINANCE &amp; CREDIT</div><div style="font-size:9.5px;color:#5a6a80;margin-top:3px;">Private Report &mdash; '+titleStr+' &mdash; '+new Date().toUTCString()+'</div></div><svg width="56" height="56" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><path id="at56" d="M 17,50 A 33,33 0 0,1 83,50"/><path id="ab56" d="M 83,50 A 33,33 0 0,1 17,50"/></defs><polygon points="50.0,3.0 56.6,8.5 64.5,5.3 69.1,12.6 77.6,12.0 79.7,20.3 88.0,22.4 87.4,30.9 94.7,35.5 91.5,43.4 97.0,50.0 91.5,56.6 94.7,64.5 87.4,69.1 88.0,77.6 79.7,79.7 77.6,88.0 69.1,87.4 64.5,94.7 56.6,91.5 50.0,97.0 43.4,91.5 35.5,94.7 30.9,87.4 22.4,88.0 20.3,79.7 12.0,77.6 12.6,69.1 5.3,64.5 8.5,56.6 3.0,50.0 8.5,43.4 5.3,35.5 12.6,30.9 12.0,22.4 20.3,20.3 22.4,12.0 30.9,12.6 35.5,5.3 43.4,8.5" fill="#0d2240"/><circle cx="50" cy="50" r="42" fill="#fdf8ef" stroke="#c9a84c" stroke-width="0.4"/><circle cx="50.0" cy="12.0" r="1.4" fill="#c9a84c"/><circle cx="59.8" cy="13.3" r="0.7" fill="#c9a84c"/><circle cx="69.0" cy="17.1" r="1.4" fill="#c9a84c"/><circle cx="76.9" cy="23.1" r="0.7" fill="#c9a84c"/><circle cx="82.9" cy="31.0" r="1.4" fill="#c9a84c"/><circle cx="86.7" cy="40.2" r="0.7" fill="#c9a84c"/><circle cx="88.0" cy="50.0" r="1.4" fill="#c9a84c"/><circle cx="86.7" cy="59.8" r="0.7" fill="#c9a84c"/><circle cx="82.9" cy="69.0" r="1.4" fill="#c9a84c"/><circle cx="76.9" cy="76.9" r="0.7" fill="#c9a84c"/><circle cx="69.0" cy="82.9" r="1.4" fill="#c9a84c"/><circle cx="59.8" cy="86.7" r="0.7" fill="#c9a84c"/><circle cx="50.0" cy="88.0" r="1.4" fill="#c9a84c"/><circle cx="40.2" cy="86.7" r="0.7" fill="#c9a84c"/><circle cx="31.0" cy="82.9" r="1.4" fill="#c9a84c"/><circle cx="23.1" cy="76.9" r="0.7" fill="#c9a84c"/><circle cx="17.1" cy="69.0" r="1.4" fill="#c9a84c"/><circle cx="13.3" cy="59.8" r="0.7" fill="#c9a84c"/><circle cx="12.0" cy="50.0" r="1.4" fill="#c9a84c"/><circle cx="13.3" cy="40.2" r="0.7" fill="#c9a84c"/><circle cx="17.1" cy="31.0" r="1.4" fill="#c9a84c"/><circle cx="23.1" cy="23.1" r="0.7" fill="#c9a84c"/><circle cx="31.0" cy="17.1" r="1.4" fill="#c9a84c"/><circle cx="40.2" cy="13.3" r="0.7" fill="#c9a84c"/><circle cx="50" cy="50" r="35" fill="none" stroke="#b8860b" stroke-width="0.5"/><circle cx="50" cy="50" r="31" fill="#0d2240" stroke="#c9a84c" stroke-width="0.8"/><text font-size="5" font-weight="800" fill="#c9a84c" letter-spacing="0.8" font-family="Arial,sans-serif"><textPath href="#at56" startOffset="10%">ALSHUMOOKH BANKING</textPath></text><text font-size="4.5" font-weight="700" fill="#c9a84c" letter-spacing="0.6" font-family="Arial,sans-serif"><textPath href="#ab56" startOffset="12%">UAE &#8226; OFFICIAL &#8226; EST.2020</textPath></text><text x="50" y="46" text-anchor="middle" font-size="4.5" font-weight="800" fill="#e2c97e" letter-spacing="1" font-family="Arial,sans-serif">ALSHUMOOKH</text><line x1="34" y1="49" x2="66" y2="49" stroke="#c9a84c" stroke-width="0.5"/><text x="50" y="57" text-anchor="middle" font-size="13" font-weight="900" fill="#e2c97e" font-family="Georgia,serif">SIG</text><line x1="34" y1="60" x2="66" y2="60" stroke="#c9a84c" stroke-width="0.5"/><text x="50" y="67" text-anchor="middle" font-size="4.5" font-weight="700" fill="#c9a84c" letter-spacing="1.5" font-family="Arial,sans-serif">SEAL</text></svg></div>'
...
function viewPayload(id) {
  api('/api/v1/admin/payloads/'+id).then(function(p) {
    ...
    var sendBlock = '<div style="margin-top:14px;border:1px solid rgba(201,168,76,0.35);border-radius:10px;overflow:hidden;">'
      ...
      +'<textarea id="sr_body_'+id+'" rows="5" style="width:100%;background:var(--surface);border:1px solid var(--glass-border);border-radius:6px;padding:8px 10px;color:var(--ink);font-size:12px;font-family:monospace;resize:vertical;box-sizing:border-box;">{"status":"SETTLEMENT_COMPLETE","reference":"'+esc(p.transaction_reference||p.id||'')+'","amount":"'+(p.amount||'')+'","asset":"'+(p.asset||'')+'","message":"Your payment has been processed by ALSHUMOOKH Global Banking Finance & Credit."}</textarea>'
      +'</div>'
...
.rpt-hero-badge{position:absolute;right:28px;top:50%;transform:translateY(-50%);display:inline-block;}
...
<div style="display:flex;flex-direction:column;gap:16px;">
  ...
  <div class="panel" style="padding:0;overflow:hidden;">
    <div class="rpt-hero">
      ...
      <div class="rpt-hero-badge"><svg width="62" height="62" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><path id="atHB" d="M 17,50 A 33,33 0 0,1 83,50"/><path id="abHB" d="M 83,50 A 33,33 0 0,1 17,50"/></defs><polygon points="50.0,3.0 56.6,8.5 64.5,5.3 69.1,12.6 77.6,12.0 79.7,20.3 88.0,22.4 87.4,30.9 94.7,35.5 91.5,43.4 97.0,50.0 91.5,56.6 94.7,64.5 87.4,69.1 88.0,77.6 79.7,79.7 77.6,88.0 69.1,87.4 64.5,94.7 56.6,91.5 50.0,97.0 43.4,91.5 35.5,94.7 30.9,87.4 22.4,88.0 20.3,79.7 12.0,77.6 12.6,69.1 5.3,64.5 8.5,56.6 3.0,50.0 8.5,43.4 5.3,35.5 12.6,30.9 12.0,22.4 20.3,20.3 22.4,12.0 30.9,12.6 35.5,5.3 43.4,8.5" fill="#0d2240"/><circle cx="50" cy="50" r="42" fill="#fdf8ef" stroke="#c9a84c" stroke-width="0.4"/><circle cx="50.0" cy="12.0" r="1.4" fill="#c9a84c" opacity="0.85"/><circle cx="59.8" cy="13.3" r="0.7" fill="#c9a84c" opacity="0.85"/><circle cx="69.0" cy="17.1" r="1.4" fill="#c9a84c" opacity="0.85"/><circle cx="76.9" cy="23.1" r="0.7" fill="#c9a84c" opacity="0.85"/><circle cx="82.9" cy="31.0" r="1.4" fill="#c9a84c" opacity="0.85"/><circle cx="86.7" cy="40.2" r="0.7" fill="#c9a84c" opacity="0.85"/><circle cx="88.0" cy="50.0" r="1.4" fill="#c9a84c" opacity="0.85"/><circle cx="86.7" cy="59.8" r="0.7" fill="#c9a84c" opacity="0.85"/><circle cx="82.9" cy="69.0" r="1.4" fill="#c9a84c" opacity="0.85"/><circle cx="76.9" cy="76.9" r="0.7" fill="#c9a84c" opacity="0.85"/><circle cx="69.0" cy="82.9" r="1.4" fill="#c9a84c" opacity="0.85"/><circle cx="59.8" cy="86.7" r="0.7" fill="#c9a84c" opacity="0.85"/><circle cx="50.0" cy="88.0" r="1.4" fill="#c9a84c" opacity="0.85"/><circle cx="40.2" cy="86.7" r="0.7" fill="#c9a84c" opacity="0.85"/><circle cx="31.0" cy="82.9" r="1.4" fill="#c9a84c" opacity="0.85"/><circle cx="23.1" cy="76.9" r="0.7" fill="#c9a84c" opacity="0.85"/><circle cx="17.1" cy="69.0" r="1.4" fill="#c9a84c" opacity="0.85"/><circle cx="13.3" cy="59.8" r="0.7" fill="#c9a84c" opacity="0.85"/><circle cx="12.0" cy="50.0" r="1.4" fill="#c9a84c" opacity="0.85"/><circle cx="13.3" cy="40.2" r="0.7" fill="#c9a84c" opacity="0.85"/><circle cx="17.1" cy="31.0" r="1.4" fill="#c9a84c" opacity="0.85"/><circle cx="23.1" cy="23.1" r="0.7" fill="#c9a84c" opacity="0.85"/><circle cx="31.0" cy="17.1" r="1.4" fill="#c9a84c" opacity="0.85"/><circle cx="40.2" cy="13.3" r="0.7" fill="#c9a84c" opacity="0.85"/><circle cx="50" cy="50" r="35" fill="none" stroke="#b8860b" stroke-width="0.5"/><circle cx="50" cy="50" r="31" fill="#0d2240" stroke="#c9a84c" stroke-width="0.8"/><text font-size="5" font-weight="800" fill="#c9a84c" letter-spacing="0.8" font-family="Arial,sans-serif"><textPath href="#atHB" startOffset="10%">ALSHUMOOKH BANKING</textPath></text><text font-size="4.5" font-weight="700" fill="#c9a84c" letter-spacing="0.6" font-family="Arial,sans-serif"><textPath href="#abHB" startOffset="12%">UAE &#8226; OFFICIAL &#8226; EST.2020</textPath></text><text x="50" y="46" text-anchor="middle" font-size="4.5" font-weight="800" fill="#e2c97e" letter-spacing="1" font-family="Arial,sans-serif">ALSHUMOOKH</text><line x1="34" y1="49" x2="66" y2="49" stroke="#c9a84c" stroke-width="0.5"/><text x="50" y="57" text-anchor="middle" font-size="13" font-weight="900" fill="#e2c97e" font-family="Georgia,serif">SIG</text><line x1="34" y1="60" x2="66" y2="60" stroke="#c9a84c" stroke-width="0.5"/><text x="50" y="67" text-anchor="middle" font-size="4.5" font-weight="700" fill="#c9a84c" letter-spacing="1.5" font-family="Arial,sans-serif">SEAL</text></svg></div>
    </div>
...
var _pCSS='body{font-family:"Helvetica Neue",Arial,sans-serif;font-size:10.5px;color:#0d1b2a;margin:0;padding:22px 28px;background:#fff;}'
  ...
  +'.dseal{display:inline-block;margin-left:12px;}'
...
function _ph(title,n){
  return '<div class="gbar"></div>'
    ...
    +'<div style="display:flex;align-items:center;"><div class="dmeta">Records: <strong>'+n+'</strong><br>'+new Date().toLocaleDateString()+'<br>Ref: RPT-'+Date.now().toString(36).toUpperCase()+'</div><svg width="56" height="56" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><path id="at56" d="M 17,50 A 33,33 0 0,1 83,50"/><path id="ab56" d="M 83,50 A 33,33 0 0,1 17,50"/></defs><polygon points="50.0,3.0 56.6,8.5 64.5,5.3 69.1,12.6 77.6,12.0 79.7,20.3 88.0,22.4 87.4,30.9 94.7,35.5 91.5,43.4 97.0,50.0 91.5,56.6 94.7,64.5 87.4,69.1 88.0,77.6 79.7,79.7 77.6,88.0 69.1,87.4 64.5,94.7 56.6,91.5 50.0,97.0 43.4,91.5 35.5,94.7 30.9,87.4 22.4,88.0 20.3,79.7 12.0,77.6 12.6,69.1 5.3,64.5 8.5,56.6 3.0,50.0 8.5,43.4 5.3,35.5 12.6,30.9 12.0,22.4 20.3,20.3 22.4,12.0 30.9,12.6 35.5,5.3 43.4,8.5" fill="#0d2240"/><circle cx="50" cy="50" r="42" fill="#fdf8ef" stroke="#c9a84c" stroke-width="0.4"/><circle cx="50.0" cy="12.0" r="1.4" fill="#c9a84c"/><circle cx="59.8" cy="13.3" r="0.7" fill="#c9a84c"/><circle cx="69.0" cy="17.1" r="1.4" fill="#c9a84c"/><circle cx="76.9" cy="23.1" r="0.7" fill="#c9a84c"/><circle cx="82.9" cy="31.0" r="1.4" fill="#c9a84c"/><circle cx="86.7" cy="40.2" r="0.7" fill="#c9a84c"/><circle cx="88.0" cy="50.0" r="1.4" fill="#c9a84c"/><circle cx="86.7" cy="59.8" r="0.7" fill="#c9a84c"/><circle cx="82.9" cy="69.0" r="1.4" fill="#c9a84c"/><circle cx="76.9" cy="76.9" r="0.7" fill="#c9a84c"/><circle cx="69.0" cy="82.9" r="1.4" fill="#c9a84c"/><circle cx="59.8" cy="86.7" r="0.7" fill="#c9a84c"/><circle cx="50.0" cy="88.0" r="1.4" fill="#c9a84c"/><circle cx="40.2" cy="86.7" r="0.7" fill="#c9a84c"/><circle cx="31.0" cy="82.9" r="1.4" fill="#c9a84c"/><circle cx="23.1" cy="76.9" r="0.7" fill="#c9a84c"/><circle cx="17.1" cy="69.0" r="1.4" fill="#c9a84c"/><circle cx="13.3" cy="59.8" r="0.7" fill="#c9a84c"/><circle cx="12.0" cy="50.0" r="1.4" fill="#c9a84c"/><circle cx="13.3" cy="40.2" r="0.7" fill="#c9a84c"/><circle cx="17.1" cy="31.0" r="1.4" fill="#c9a84c"/><circle cx="23.1" cy="23.1" r="0.7" fill="#c9a84c"/><circle cx="31.0" cy="17.1" r="1.4" fill="#c9a84c"/><circle cx="40.2" cy="13.3" r="0.7" fill="#c9a84c"/><circle cx="50" cy="50" r="35" fill="none" stroke="#b8860b" stroke-width="0.5"/><circle cx="50" cy="50" r="31" fill="#0d2240" stroke="#c9a84c" stroke-width="0.8"/><text font-size="5" font-weight="800" fill="#c9a84c" letter-spacing="0.8" font-family="Arial,sans-serif"><textPath href="#at56" startOffset="10%">ALSHUMOOKH BANKING</textPath></text><text font-size="4.5" font-weight="700" fill="#c9a84c" letter-spacing="0.6" font-family="Arial,sans-serif"><textPath href="#ab56" startOffset="12%">UAE &#8226; OFFICIAL &#8226; EST.2020</textPath></text><text x="50" y="46" text-anchor="middle" font-size="4.5" font-weight="800" fill="#e2c97e" letter-spacing="1" font-family="Arial,sans-serif">ALSHUMOOKH</text><line x1="34" y1="49" x2="66" y2="49" stroke="#c9a84c" stroke-width="0.5"/><text x="50" y="57" text-anchor="middle" font-size="13" font-weight="900" fill="#e2c97e" font-family="Georgia,serif">SIG</text><line x1="34" y1="60" x2="66" y2="60" stroke="#c9a84c" stroke-width="0.5"/><text x="50" y="67" text-anchor="middle" font-size="4.5" font-weight="700" fill="#c9a84c" letter-spacing="1.5" font-family="Arial,sans-serif">SEAL</text></svg></div></div>';}
function _pf(){return '<div class="foot"><div class="ftxt">This document is auto-generated by ALSHUMOOKH internal system. CONFIDENTIAL &mdash; authorised personnel only.<br>&copy; ALSHUMOOKH GROUP 2026 &mdash; compliance@alshumookh-pay.com</div><svg width="48" height="48" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><path id="at48" d="M 17,50 A 33,33 0 0,1 83,50"/><path id="ab48" d="M 83,50 A 33,33 0 0,1 17,50"/></defs><polygon points="50.0,3.0 56.6,8.5 64.5,5.3 69.1,12.6 77.6,12.0 79.7,20.3 88.0,22.4 87.4,30.9 94.7,35.5 91.5,43.4 97.0,50.0 91.5,56.6 94.7,64.5 87.4,69.1 88.0,77.6 79.7,79.7 77.6,88.0 69.1,87.4 64.5,94.7 56.6,91.5 50.0,97.0 43.4,91.5 35.5,94.7 30.9,87.4 22.4,88.0 20.3,79.7 12.0,77.6 12.6,69.1 5.3,64.5 8.5,56.6 3.0,50.0 8.5,43.4 5.3,35.5 12.6,30.9 12.0,22.4 20.3,20.3 22.4,12.0 30.9,12.6 35.5,5.3 43.4,8.5" fill="#0d2240"/><circle cx="50" cy="50" r="42" fill="#fdf8ef" stroke="#c9a84c" stroke-width="0.4"/><circle cx="50.0" cy="12.0" r="1.4" fill="#c9a84c"/><circle cx="59.8" cy="13.3" r="0.7" fill="#c9a84c"/><circle cx="69.0" cy="17.1" r="1.4" fill="#c9a84c"/><circle cx="76.9" cy="23.1" r="0.7" fill="#c9a84c"/><circle cx="82.9" cy="31.0" r="1.4" fill="#c9a84c"/><circle cx="86.7" cy="40.2" r="0.7" fill="#c9a84c"/><circle cx="88.0" cy="50.0" r="1.4" fill="#c9a84c"/><circle cx="86.7" cy="59.8" r="0.7" fill="#c9a84c"/><circle cx="82.9" cy="69.0" r="1.4" fill="#c9a84c"/><circle cx="76.9" cy="76.9" r="0.7" fill="#c9a84c"/><circle cx="69.0" cy="82.9" r="1.4" fill="#c9a84c"/><circle cx="59.8" cy="86.7" r="0.7" fill="#c9a84c"/><circle cx="50.0" cy="88.0" r="1.4" fill="#c9a84c"/><circle cx="40.2" cy="86.7" r="0.7" fill="#c9a84c"/><circle cx="31.0" cy="82.9" r="1.4" fill="#c9a84c"/><circle cx="23.1" cy="76.9" r="0.7" fill="#c9a84c"/><circle cx="17.1" cy="69.0" r="1.4" fill="#c9a84c"/><circle cx="13.3" cy="59.8" r="0.7" fill="#c9a84c"/><circle cx="12.0" cy="50.0" r="1.4" fill="#c9a84c"/><circle cx="13.3" cy="40.2" r="0.7" fill="#c9a84c"/><circle cx="17.1" cy="31.0" r="1.4" fill="#c9a84c"/><circle cx="23.1" cy="23.1" r="0.7" fill="#c9a84c"/><circle cx="31.0" cy="17.1" r="1.4" fill="#c9a84c"/><circle cx="40.2" cy="13.3" r="0.7" fill="#c9a84c"/><circle cx="50" cy="50" r="35" fill="none" stroke="#b8860b" stroke-width="0.5"/><circle cx="50" cy="50" r="31" fill="#0d2240" stroke="#c9a84c" stroke-width="0.8"/><text font-size="5" font-weight="800" fill="#c9a84c" letter-spacing="0.8" font-family="Arial,sans-serif"><textPath href="#at48" startOffset="10%">ALSHUMOOKH BANKING</textPath></text><text font-size="4.5" font-weight="700" fill="#c9a84c" letter-spacing="0.6" font-family="Arial,sans-serif"><textPath href="#ab48" startOffset="12%">UAE &#8226; OFFICIAL &#8226; EST.2020</textPath></text><text x="50" y="46" text-anchor="middle" font-size="4.5" font-weight="800" fill="#e2c97e" letter-spacing="1" font-family="Arial,sans-serif">ALSHUMOOKH</text><line x1="34" y1="49" x2="66" y2="49" stroke="#c9a84c" stroke-width="0.5"/><text x="50" y="57" text-anchor="middle" font-size="13" font-weight="900" fill="#e2c97e" font-family="Georgia,serif">SIG</text><line x1="34" y1="60" x2="66" y2="60" stroke="#c9a84c" stroke-width="0.5"/><text x="50" y="67" text-anchor="middle" font-size="4.5" font-weight="700" fill="#c9a84c" letter-spacing="1.5" font-family="Arial,sans-serif">SEAL</text></svg></div>';}
...
function printTxReport(idx,type){
  ...
  var html='<!doctype html><html><head><meta charset=utf-8><title>'+title+'</title><style>'+css+'</style></head><body>'
    ...
    +'<div class="hdr"><div><div class="co">ALSHUMOOKH GLOBAL BANKING FINANCE &amp; CREDIT</div><div class="co-sub">Authorised Financial Institution &mdash; United Arab Emirates</div></div><svg width="56" height="56" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><path id="at56" d="M 17,50 A 33,33 0 0,1 83,50"/><path id="ab56" d="M 83,50 A 33,33 0 0,1 17,50"/></defs><polygon points="50.0,3.0 56.6,8.5 64.5,5.3 69.1,12.6 77.6,12.0 79.7,20.3 88.0,22.4 87.4,30.9 94.7,35.5 91.5,43.4 97.0,50.0 91.5,56.6 94.7,64.5 87.4,69.1 88.0,77.6 79.7,79.7 77.6,88.0 69.1,87.4 64.5,94.7 56.6,91.5 50.0,97.0 43.4,91.5 35.5,94.7 30.9,87.4 22.4,88.0 20.3,79.7 12.0,77.6 12.6,69.1 5.3,64.5 8.5,56.6 3.0,50.0 8.5,43.4 5.3,35.5 12.6,30.9 12.0,22.4 20.3,20.3 22.4,12.0 30.9,12.6 35.5,5.3 43.4,8.5" fill="#0d2240"/><circle cx="50" cy="50" r="42" fill="#fdf8ef" stroke="#c9a84c" stroke-width="0.4"/><circle cx="50.0" cy="12.0" r="1.4" fill="#c9a84c"/><circle cx="59.8" cy="13.3" r="0.7" fill="#c9a84c"/><circle cx="69.0" cy="17.1" r="1.4" fill="#c9a84c"/><circle cx="76.9" cy="23.1" r="0.7" fill="#c9a84c"/><circle cx="82.9" cy="31.0" r="1.4" fill="#c9a84c"/><circle cx="86.7" cy="40.2" r="0.7" fill="#c9a84c"/><circle cx="88.0" cy="50.0" r="1.4" fill="#c9a84c"/><circle cx="86.7" cy="59.8" r="0.7" fill="#c9a84c"/><circle cx="82.9" cy="69.0" r="1.4" fill="#c9a84c"/><circle cx="76.9" cy="76.9" r="0.7" fill="#c9a84c"/><circle cx="69.0" cy="82.9" r="1.4" fill="#c9a84c"/><circle cx="59.8" cy="86.7" r="0.7" fill="#c9a84c"/><circle cx="50.0" cy="88.0" r="1.4" fill="#c9a84c"/><circle cx="40.2" cy="86.7" r="0.7" fill="#c9a84c"/><circle cx="31.0" cy="82.9" r="1.4" fill="#c9a84c"/><circle cx="23.1" cy="76.9" r="0.7" fill="#c9a84c"/><circle cx="17.1" cy="69.0" r="1.4" fill="#c9a84c"/><circle cx="13.3" cy="59.8" r="0.7" fill="#c9a84c"/><circle cx="12.0" cy="50.0" r="1.4" fill="#c9a84c"/><circle cx="13.3" cy="40.2" r="0.7" fill="#c9a84c"/><circle cx="17.1" cy="31.0" r="1.4" fill="#c9a84c"/><circle cx="23.1" cy="23.1" r="0.7" fill="#c9a84c"/><circle cx="31.0" cy="17.1" r="1.4" fill="#c9a84c"/><circle cx="40.2" cy="13.3" r="0.7" fill="#c9a84c"/><circle cx="50" cy="50" r="35" fill="none" stroke="#b8860b" stroke-width="0.5"/><circle cx="50" cy="50" r="31" fill="#0d2240" stroke="#c9a84c" stroke-width="0.8"/><text font-size="5" font-weight="800" fill="#c9a84c" letter-spacing="0.8" font-family="Arial,sans-serif"><textPath href="#at56" startOffset="10%">ALSHUMOOKH BANKING</textPath></text><text font-size="4.5" font-weight="700" fill="#c9a84c" letter-spacing="0.6" font-family="Arial,sans-serif"><textPath href="#ab56" startOffset="12%">UAE &#8226; OFFICIAL &#8226; EST.2020</textPath></text><text x="50" y="46" text-anchor="middle" font-size="4.5" font-weight="800" fill="#e2c97e" letter-spacing="1" font-family="Arial,sans-serif">ALSHUMOOKH</text><line x1="34" y1="49" x2="66" y2="49" stroke="#c9a84c" stroke-width="0.5"/><text x="50" y="57" text-anchor="middle" font-size="13" font-weight="900" fill="#e2c97e" font-family="Georgia,serif">SIG</text><line x1="34" y1="60" x2="66" y2="60" stroke="#c9a84c" stroke-width="0.5"/><text x="50" y="67" text-anchor="middle" font-size="4.5" font-weight="700" fill="#c9a84c" letter-spacing="1.5" font-family="Arial,sans-serif">SEAL</text></svg></div>'
    ...
    +'<table>'+rowsHTML+'</table>'
    +'</div>'
    +'<div class="foot"><div class="ftxt">This document is auto-generated by the ALSHUMOOKH internal system and is CONFIDENTIAL &mdash; authorised personnel only.<br>Blockchain data is subject to network confirmation. All amounts are as recorded at time of transaction. &copy; ALSHUMOOKH GROUP 2026 &mdash; compliance@alshumookh-pay.com</div><svg width="48" height="48" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><path id="at48" d="M 17,50 A 33,33 0 0,1 83,50"/><path id="ab48" d="M 83,50 A 33,33 0 0,1 17,50"/></defs><polygon points="50.0,3.0 56.6,8.5 64.5,5.3 69.1,12.6 77.6,12.0 79.7,20.3 88.0,22.4 87.4,30.9 94.7,35.5 91.5,43.4 97.0,50.0 91.5,56.6 94.7,64.5 87.4,69.1 88.0,77.6 79.7,79.7 77.6,88.0 69.1,87.4 64.5,94.7 56.6,91.5 50.0,97.0 43.4,91.5 35.5,94.7 30.9,87.4 22.4,88.0 20.3,79.7 12.0,77.6 12.6,69.1 5.3,64.5 8.5,56.6 3.0,50.0 8.5,43.4 5.3,35.5 12.6,30.9 12.0,22.4 20.3,20.3 22.4,12.0 30.9,12.6 35.5,5.3 43.4,8.5" fill="#0d2240"/><circle cx="50" cy="50" r="42" fill="#fdf8ef" stroke="#c9a84c" stroke-width="0.4"/><circle cx="50.0" cy="12.0" r="1.4" fill="#c9a84c"/><circle cx="59.8" cy="13.3" r="0.7" fill="#c9a84c"/><circle cx="69.0" cy="17.1" r="1.4" fill="#c9a84c"/><circle cx="76.9" cy="23.1" r="0.7" fill="#c9a84c"/><circle cx="82.9" cy="31.0" r="1.4" fill="#c9a84c"/><circle cx="86.7" cy="40.2" r="0.7" fill="#c9a84c"/><circle cx="88.0" cy="50.0" r="1.4" fill="#c9a84c"/><circle cx="86.7" cy="59.8" r="0.7" fill="#c9a84c"/><circle cx="82.9" cy="69.0" r="1.4" fill="#c9a84c"/><circle cx="76.9" cy="76.9" r="0.7" fill="#c9a84c"/><circle cx="69.0" cy="82.9" r="1.4" fill="#c9a84c"/><circle cx="59.8" cy="86.7" r="0.7" fill="#c9a84c"/><circle cx="50.0" cy="88.0" r="1.4" fill="#c9a84c"/><circle cx="40.2" cy="86.7" r="0.7" fill="#c9a84c"/><circle cx="31.0" cy="82.9" r="1.4" fill="#c9a84c"/><circle cx="23.1" cy="76.9" r="0.7" fill="#c9a84c"/><circle cx="17.1" cy="69.0" r="1.4" fill="#c9a84c"/><circle cx="13.3" cy="59.8" r="0.7" fill="#c9a84c"/><circle cx="12.0" cy="50.0" r="1.4" fill="#c9a84c"/><circle cx="13.3" cy="40.2" r="0.7" fill="#c9a84c"/><circle cx="17.1" cy="31.0" r="1.4" fill="#c9a84c"/><circle cx="23.1" cy="23.1" r="0.7" fill="#c9a84c"/><circle cx="31.0" cy="17.1" r="1.4" fill="#c9a84c"/><circle cx="40.2" cy="13.3" r="0.7" fill="#c9a84c"/><circle cx="50" cy="50" r="35" fill="none" stroke="#b8860b" stroke-width="0.5"/><circle cx="50" cy="50" r="31" fill="#0d2240" stroke="#c9a84c" stroke-width="0.8"/><text font-size="5" font-weight="800" fill="#c9a84c" letter-spacing="0.8" font-family="Arial,sans-serif"><textPath href="#at48" startOffset="10%">ALSHUMOOKH BANKING</textPath></text><text font-size="4.5" font-weight="700" fill="#c9a84c" letter-spacing="0.6" font-family="Arial,sans-serif"><textPath href="#ab48" startOffset="12%">UAE &#8226; OFFICIAL &#8226; EST.2020</textPath></text><text x="50" y="46" text-anchor="middle" font-size="4.5" font-weight="800" fill="#e2c97e" letter-spacing="1" font-family="Arial,sans-serif">ALSHUMOOKH</text><line x1="34" y1="49" x2="66" y2="49" stroke="#c9a84c" stroke-width="0.5"/><text x="50" y="57" text-anchor="middle" font-size="13" font-weight="900" fill="#e2c97e" font-family="Georgia,serif">SIG</text><line x1="34" y1="60" x2="66" y2="60" stroke="#c9a84c" stroke-width="0.5"/><text x="50" y="67" text-anchor="middle" font-size="4.5" font-weight="700" fill="#c9a84c" letter-spacing="1.5" font-family="Arial,sans-serif">SEAL</text></svg></div>'
    +'</body></html>';
...
function prBuildPrintHTML(type, d, meta, titleStr, ref) {
  ...
  var parts = [
    ...
    +   '<defs>'
    +     '<path id="arcTopS" d="M 18,70 A 52,52 0 0,1 122,70"/>'
    +     '<path id="arcBotS" d="M 122,70 A 52,52 0 0,1 18,70"/>'
    +   '</defs>'
    +   '<polygon points="70.00,3.00 74.79,9.19 80.48,3.82 84.24,10.69 90.70,6.28 93.34,13.64 100.42,10.30 101.87,17.99 109.38,15.80 109.62,23.62 117.38,22.62 116.38,30.38 124.20,30.62 122.01,38.13 129.70,39.58 126.36,46.66 133.72,49.30 129.31,55.76 136.18,59.52 130.81,65.21 137.00,70.00 130.81,74.79 136.18,80.48 129.31,84.24 133.72,90.70 126.36,93.34 129.70,100.42 122.01,101.87 124.20,109.38 116.38,109.62 117.38,117.38 109.62,116.38 109.38,124.20 101.87,122.01 100.42,129.70 93.34,126.36 90.70,133.72 84.24,129.31 80.48,136.18 74.79,130.81 70.00,137.00 65.21,130.81 59.52,136.18 55.76,129.31 49.30,133.72 46.66,126.36 39.58,129.70 38.13,122.01 30.62,124.20 30.38,116.38 22.62,117.38 23.62,109.62 15.80,109.38 17.99,101.87 10.30,100.42 13.64,93.34 6.28,90.70 10.69,84.24 3.82,80.48 9.19,74.79 3.00,70.00 9.19,65.21 3.82,59.52 10.69,55.76 6.28,49.30 13.64,46.66 10.30,39.58 17.99,38.13 15.80,30.62 23.62,30.38 22.62,22.62 30.38,23.62 30.62,15.80 38.13,17.99 39.58,10.30 46.66,13.64 49.30,6.28 55.76,10.69 59.52,3.82 65.21,9.19" fill="#0d2240"/>'
    +   '<circle cx="70" cy="70" r="63" fill="#fdf8ef" stroke="#c9a84c" stroke-width="0.5"/>'
    +   '<circle cx="70.00" cy="11.00" r="1.6" fill="#c9a84c"/><circle cx="77.70" cy="11.50" r="0.9" fill="#c9a84c"/><circle cx="85.27" cy="13.01" r="1.6" fill="#c9a84c"/><circle cx="92.58" cy="15.49" r="0.9" fill="#c9a84c"/><circle cx="99.50" cy="18.90" r="1.6" fill="#c9a84c"/><circle cx="105.92" cy="23.19" r="0.9" fill="#c9a84c"/><circle cx="111.72" cy="28.28" r="1.6" fill="#c9a84c"/><circle cx="116.81" cy="34.08" r="0.9" fill="#c9a84c"/><circle cx="121.10" cy="40.50" r="1.6" fill="#c9a84c"/><circle cx="124.51" cy="47.42" r="0.9" fill="#c9a84c"/><circle cx="126.99" cy="54.73" r="1.6" fill="#c9a84c"/><circle cx="128.50" cy="62.30" r="0.9" fill="#c9a84c"/><circle cx="129.00" cy="70.00" r="1.6" fill="#c9a84c"/><circle cx="128.50" cy="77.70" r="0.9" fill="#c9a84c"/><circle cx="126.99" cy="85.27" r="1.6" fill="#c9a84c"/><circle cx="124.51" cy="92.58" r="0.9" fill="#c9a84c"/><circle cx="121.10" cy="99.50" r="1.6" fill="#c9a84c"/><circle cx="116.81" cy="105.92" r="0.9" fill="#c9a84c"/><circle cx="111.72" cy="111.72" r="1.6" fill="#c9a84c"/><circle cx="105.92" cy="116.81" r="0.9" fill="#c9a84c"/><circle cx="99.50" cy="121.10" r="1.6" fill="#c9a84c"/><circle cx="92.58" cy="124.51" r="0.9" fill="#c9a84c"/><circle cx="85.27" cy="126.99" r="1.6" fill="#c9a84c"/><circle cx="77.70" cy="128.50" r="0.9" fill="#c9a84c"/><circle cx="70.00" cy="129.00" r="1.6" fill="#c9a84c"/><circle cx="62.30" cy="128.50" r="0.9" fill="#c9a84c"/><circle cx="54.73" cy="126.99" r="1.6" fill="#c9a84c"/><circle cx="47.42" cy="124.51" r="0.9" fill="#c9a84c"/><circle cx="40.50" cy="121.10" r="1.6" fill="#c9a84c"/><circle cx="34.08" cy="116.81" r="0.9" fill="#c9a84c"/><circle cx="28.28" cy="111.72" r="1.6" fill="#c9a84c"/><circle cx="23.19" cy="105.92" r="0.9" fill="#c9a84c"/><circle cx="18.90" cy="99.50" r="1.6" fill="#c9a84c"/><circle cx="15.49" cy="92.58" r="0.9" fill="#c9a84c"/><circle cx="13.01" cy="85.27" r="1.6" fill="#c9a84c"/><circle cx="11.50" cy="77.70" r="0.9" fill="#c9a84c"/><circle cx="11.00" cy="70.00" r="1.6" fill="#c9a84c"/><circle cx="11.50" cy="62.30" r="0.9" fill="#c9a84c"/><circle cx="13.01" cy="54.73" r="1.6" fill="#c9a84c"/><circle cx="15.49" cy="47.42" r="0.9" fill="#c9a84c"/><circle cx="18.90" cy="40.50" r="1.6" fill="#c9a84c"/><circle cx="23.19" cy="34.08" r="0.9" fill="#c9a84c"/><circle cx="28.28" cy="28.28" r="1.6" fill="#c9a84c"/><circle cx="34.08" cy="23.19" r="0.9" fill="#c9a84c"/><circle cx="40.50" cy="18.90" r="1.6" fill="#c9a84c"/><circle cx="47.42" cy="15.49" r="0.9" fill="#c9a84c"/><circle cx="54.73" cy="13.01" r="1.6" fill="#c9a84c"/><circle cx="62.30" cy="11.50" r="0.9" fill="#c9a84c"/>'
    +   '<circle cx="70" cy="70" r="55" fill="none" stroke="#b8860b" stroke-width="0.6"/>'
    +   '<circle cx="70" cy="70" r="53" fill="none" stroke="#c9a84c" stroke-width="0.4" stroke-dasharray="2,2"/>'
    +   '<text font-size="5.4" font-weight="800" fill="#7a5400" letter-spacing="1.4" font-family="Arial,sans-serif">'
    +     '<textPath href="#arcTopS" startOffset="5%">&#9670; ALSHUMOOKH GLOBAL BANKING &#9670;</textPath>'
    +   '</text>'
    +   '<text font-size="5" font-weight="700" fill="#9a6f10" letter-spacing="1.2" font-family="Arial,sans-serif">'
    +     '<textPath href="#arcBotS" startOffset="3%">FINANCE &amp; CREDIT &#8226; UAE &#8226; EST.2020</textPath>'
    +   '</text>'
    +   '<circle cx="70" cy="70" r="47" fill="#0d2240" stroke="#c9a84c" stroke-width="1"/>'
    +   '<text x="70" y="56" text-anchor="middle" font-size="5.5" font-weight="800" fill="#e2c97e" letter-spacing="2" font-family="Arial,sans-serif">ALSHUMOOKH</text>'
    +   '<line x1="50" y1="59" x2="90" y2="59" stroke="#c9a84c" stroke-width="0.6"/>'
    +   '<line x1="52" y1="60.5" x2="88" y2="60.5" stroke="#b8860b" stroke-width="0.3"/>'
    +   '<text x="70" y="75" text-anchor="middle" font-size="16" font-weight="900" fill="#e2c97e" font-family="Georgia,serif">SIG</text>'
    +   '<line x1="52" y1="79" x2="88" y2="79" stroke="#b8860b" stroke-width="0.3"/>'
    +   '<line x1="50" y1="80.5" x2="90" y2="80.5" stroke="#c9a84c" stroke-width="0.6"/>'
    +   '<text x="70" y="88" text-anchor="middle" font-size="6" font-weight="800" fill="#e2c97e" letter-spacing="2.5" font-family="Arial,sans-serif">OFFICIAL</text>'
    +   '<text x="70" y="95" text-anchor="middle" font-size="5" font-weight="700" fill="#c9a84c" letter-spacing="2" font-family="Arial,sans-serif">BANKING SEAL</text>'
    +   '<polygon points="70,101 72,104 70,107 68,104" fill="#c9a84c"/>'
    +   '<polygon points="62,101 64,104 62,107 60,104" fill="#c9a84c" opacity="0.7"/>'
    +   '<polygon points="78,101 80,104 78,107 76,104" fill="#c9a84c" opacity="0.7"/>'
    + '</svg>'
    + '</div>',
    '</div>',
...
function prPrintAll() {
  ...
  var parts = [
    ...
    '<svg width="48" height="48" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><path id="at48" d="M 17,50 A 33,33 0 0,1 83,50"/><path id="ab48" d="M 83,50 A 33,33 0 0,1 17,50"/></defs><polygon points="50.0,3.0 56.6,8.5 64.5,5.3 69.1,12.6 77.6,12.0 79.7,20.3 88.0,22.4 87.4,30.9 94.7,35.5 91.5,43.4 97.0,50.0 91.5,56.6 94.7,64.5 87.4,69.1 88.0,77.6 79.7,79.7 77.6,88.0 69.1,87.4 64.5,94.7 56.6,91.5 50.0,97.0 43.4,91.5 35.5,94.7 30.9,87.4 22.4,88.0 20.3,79.7 12.0,77.6 12.6,69.1 5.3,64.5 8.5,56.6 3.0,50.0 8.5,43.4 5.3,35.5 12.6,30.9 12.0,22.4 20.3,20.3 22.4,12.0 30.9,12.6 35.5,5.3 43.4,8.5" fill="#0d2240"/><circle cx="50" cy="50" r="42" fill="#fdf8ef" stroke="#c9a84c" stroke-width="0.4"/><circle cx="50.0" cy="12.0" r="1.4" fill="#c9a84c"/><circle cx="59.8" cy="13.3" r="0.7" fill="#c9a84c"/><circle cx="69.0" cy="17.1" r="1.4" fill="#c9a84c"/><circle cx="76.9" cy="23.1" r="0.7" fill="#c9a84c"/><circle cx="82.9" cy="31.0" r="1.4" fill="#c9a84c"/><circle cx="86.7" cy="40.2" r="0.7" fill="#c9a84c"/><circle cx="88.0" cy="50.0" r="1.4" fill="#c9a84c"/><circle cx="86.7" cy="59.8" r="0.7" fill="#c9a84c"/><circle cx="82.9" cy="69.0" r="1.4" fill="#c9a84c"/><circle cx="76.9" cy="76.9" r="0.7" fill="#c9a84c"/><circle cx="69.0" cy="82.9" r="1.4" fill="#c9a84c"/><circle cx="59.8" cy="86.7" r="0.7" fill="#c9a84c"/><circle cx="50.0" cy="88.0" r="1.4" fill="#c9a84c"/><circle cx="40.2" cy="86.7" r="0.7" fill="#c9a84c"/><circle cx="31.0" cy="82.9" r="1.4" fill="#c9a84c"/><circle cx="23.1" cy="76.9" r="0.7" fill="#c9a84c"/><circle cx="17.1" cy="69.0" r="1.4" fill="#c9a84c"/><circle cx="13.3" cy="59.8" r="0.7" fill="#c9a84c"/><circle cx="12.0" cy="50.0" r="1.4" fill="#c9a84c"/><circle cx="13.3" cy="40.2" r="0.7" fill="#c9a84c"/><circle cx="17.1" cy="31.0" r="1.4" fill="#c9a84c"/><circle cx="23.1" cy="23.1" r="0.7" fill="#c9a84c"/><circle cx="31.0" cy="17.1" r="1.4" fill="#c9a84c"/><circle cx="40.2" cy="13.3" r="0.7" fill="#c9a84c"/><circle cx="50" cy="50" r="35" fill="none" stroke="#b8860b" stroke-width="0.5"/><circle cx="50" cy="50" r="31" fill="#0d2240" stroke="#c9a84c" stroke-width="0.8"/><text font-size="5" font-weight="800" fill="#c9a84c" letter-spacing="0.8" font-family="Arial,sans-serif"><textPath href="#at48" startOffset="10%">ALSHUMOOKH BANKING</textPath></text><text font-size="4.5" font-weight="700" fill="#c9a84c" letter-spacing="0.6" font-family="Arial,sans-serif"><textPath href="#ab48" startOffset="12%">UAE &#8226; OFFICIAL &#8226; EST.2020</textPath></text><text x="50" y="46" text-anchor="middle" font-size="4.5" font-weight="800" fill="#e2c97e" letter-spacing="1" font-family="Arial,sans-serif">ALSHUMOOKH</text><line x1="34" y1="49" x2="66" y2="49" stroke="#c9a84c" stroke-width="0.5"/><text x="50" y="57" text-anchor="middle" font-size="13" font-weight="900" fill="#e2c97e" font-family="Georgia,serif">SIG</text><line x1="34" y1="60" x2="66" y2="60" stroke="#c9a84c" stroke-width="0.5"/><text x="50" y="67" text-anchor="middle" font-size="4.5" font-weight="700" fill="#c9a84c" letter-spacing="1.5" font-family="Arial,sans-serif">SEAL</text></svg></div>',
...
.dist-card h3{font-size:13px;font-weight:700;color:var(--gold);margin:0 0 14px;text-transform:uppercase;letter-spacing:.06em;}
.dist-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;}
.dist-grid.three{grid-template-columns:1fr 1fr 1fr;}
.dist-grid.four{grid-template-columns:1fr 1fr 1fr 1fr;}
@media(max-width:700px){.dist-grid,.dist-grid.three,.dist-grid.four{grid-template-columns:1fr 1fr;}}
@media(max-width:460px){.dist-grid,.dist-grid.three,.dist-grid.four{grid-template-columns:1fr;}}
.dist-stat{background:rgba(255,255,255,.04);border-radius:8px;padding:12px 14px;}
.dist-stat label{font-size:10px;color:var(--muted);display:block;margin-bottom:4px;text-transform:uppercase;letter-spacing:.04em;}
.dist-stat .val{font-size:16px;font-weight:800;color:#f0f0f0;word-break:break-all;}
.dist-stat .sub{font-size:10px;color:var(--muted);margin-top:2px;}
.dist-btn{display:inline-flex;align-items:center;gap:7px;padding:9px 18px;border-radius:8px;font-size:12px;font-weight:600;cursor:pointer;border:none;transition:.18s;}
...
.dist-btn.gold{background:linear-gradient(135deg,#d97706,#b45309);color:#fff;}
...
.wallet-bar{display:flex;align-items:center;gap:10px;padding:10px 16px;background:rgba(124,58,237,.1);border:1px solid rgba(124,58,237,.25);border-radius:10px;margin-bottom:16px;}
.wallet-bar code{font-size:12px;color:#c4b5fd;flex:1;}
#distLog{background:#0a0a0f;border:1px solid var(--border);border-radius:8px;padding:12px;font-size:11px;color:#6ee7b7;height:110px;overflow-y:auto;font-family:monospace;white-space:pre-wrap;margin-top:10px;}
.payee-row{display:flex;align-items:center;gap:8px;margin-bottom:8px;}
.payee-row input{flex:1;background:rgba(255,255,255,.06);border:1px solid var(--border);border-radius:6px;padding:7px 10px;color:#f0f0f0;font-size:12px;font-family:monospace;}
.payee-row .bps-input{width:80px;flex:none;text-align:center;}
.bps-pct{font-size:11px;color:#a78bfa;min-width:42px;text-align:right;}
.dist-tabs{display:flex;gap:0;margin-bottom:18px;border-bottom:2px solid var(--border);}
.dist-tab{padding:9px 18px;font-size:12px;font-weight:600;cursor:pointer;border:none;background:none;color:var(--muted);border-bottom:2px solid transparent;margin-bottom:-2px;transition:.15s;}
.dist-tab.active{color:var(--gold);border-bottom-color:var(--gold);}
.dist-section{display:none;}.dist-section.active{display:block;}
</style>

<!-- System Profit Overview -->
<div class="dist-card" style="border-color:rgba(251,191,36,.4);background:rgba(251,191,36,.03);">
  <h3>📊 System Profit Overview</h3>
  <div class="dist-grid four" id="profitStats">
    <div class="dist-stat"><label>Total EUR Processed</label><div class="val" id="pEur">—</div><div class="sub">Fiat Deposits + M1 Jobs</div></div>
    <div class="dist-stat"><label>SIG Tokens Issued</label><div class="val" id="pSig" style="color:#a78bfa;">—</div><div class="sub">M1 Tokenization</div></div>
    <div class="dist-stat"><label>USDT Settled</label><div class="val" id="pUsdt" style="color:#34d399;">—</div><div class="sub">Outbound Transfers</div></div>
    <div class="dist-stat"><label>Completed Quotes</label><div class="val" id="pQuotes" style="color:var(--gold);">—</div><div class="sub">OTC EUR→USDT</div></div>
  </div>
  <div style="margin-top:12px;display:flex;gap:10px;flex-wrap:wrap;">
    <button class="dist-btn ghost" onclick="loadProfitOverview()" style="font-size:11px;padding:6px 14px;">🔄 Refresh Stats</button>
    <button class="dist-btn gold" onclick="calcDistribution()" style="font-size:11px;padding:6px 14px;">⚡ Calculate Distribution</button>
  </div>
  <div id="calcResult" style="display:none;margin-top:12px;padding:14px 16px;background:rgba(124,58,237,.08);border:1px solid rgba(124,58,237,.3);border-radius:8px;font-size:12px;"></div>
</div>

<!-- Tabs -->
<div class="dist-tabs">
  <button class="dist-tab active" onclick="switchTab('blockchain')">⛓ Blockchain</button>
  <button class="dist-tab" onclick="switchTab('payees')">👥 Payees</button>
  <button class="dist-tab" onclick="switchTab('deposit')">💰 Deposit</button>
  <button class="dist-tab" onclick="switchTab('claim')">🏦 Claim</button>
  <button class="dist-tab" onclick="switchTab('registry')">🗂 Registry</button>
</div>

<!-- TAB: Blockchain -->
<div id="tab-blockchain" class="dist-section active">
  <!-- Wallet Connect -->
  <div class="wallet-bar">
    ...
    <button class="dist-btn ghost" onclick="diagWallet()" style="font-size:10px;padding:5px 10px;" title="Diagnose">🔍</button>
    <span id="walletBalance" style="font-size:11px;color:#34d399;display:none;white-space:nowrap;"></span>
    <select id="networkSelect" class="dist-input" style="width:150px;margin:0;" onchange="switchNetwork()">
  ...
  <!-- Deploy Contract -->
  <div class="dist-card" style="border-color:rgba(124,58,237,.4);">
    <h3>🚀 Deploy New Contract</h3>
    <p style="font-size:11px;color:var(--muted);margin:0 0 12px;">Deploy SIGProfitDistributor via MetaMask — no Terminal or private key needed.</p>
    <label style="font-size:11px;color:var(--muted);">Owner Address</label>
    <input class="dist-input" id="deployOwner" placeholder="0x... your main wallet" style="margin:6px 0 10px;" />
    <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap;">
      <button class="dist-btn primary" onclick="deployContract()" id="deployBtn">🚀 Deploy Contract</button>
      <span id="deployStatus" style="font-size:11px;color:var(--muted);"></span>
    </div>
    <div id="deployResult" style="display:none;margin-top:12px;padding:12px 14px;background:rgba(5,150,105,.08);border:1px solid rgba(5,150,105,.3);border-radius:8px;">
      <p style="font-size:12px;color:#34d399;margin:0 0 8px;font-weight:700;">✅ Contract deployed!</p>
      <div style="display:flex;gap:8px;margin-top:4px;">
        ...
        <button class="dist-btn ghost" onclick="useDeployedContract()" style="white-space:nowrap;">⬇️ Use This</button>
      </div>
      <div id="deployExplorerLink" style="margin-top:8px;font-size:11px;"></div>
    </div>
  </div>
  ...
  <div class="dist-card">
    ...
    <label style="font-size:11px;color:var(--muted);">SIGProfitDistributor Contract Address</label>
    <input class="dist-input" id="contractAddr" placeholder="0x..." style="margin:6px 0 10px;" />
    <div style="display:flex;gap:10px;flex-wrap:wrap;align-items:center;">
      <button class="dist-btn ghost" onclick="loadContractState()">🔄 Load Contract State</button>
      <span id="contractStatus" style="font-size:11px;color:var(--muted);"></span>
    </div>
  </div>
  ...
  <div class="dist-card" id="stateCard" style="display:none;">
    ...
    <div class="dist-grid three" style="margin-bottom:12px;">
      <div class="dist-stat"><label>Shares Frozen</label><span class="val" id="stSharesFrozen">—</span></div>
      <div class="dist-stat"><label>Deposits Closed</label><span class="val" id="stDepositsClosed">—</span></div>
      <div class="dist-stat"><label>Payee Count</label><span class="val" id="stPayeeCount">—</span></div>
    </div>
    <div class="dist-grid" style="margin-bottom:12px;">
      <div class="dist-stat"><label>ETH Received (total)</label><span class="val" id="stNativeReceived">—</span></div>
      <div class="dist-stat"><label>ETH Tracked Balance</label><span class="val" id="stNativeTracked">—</span></div>
    </div>
  ...
  <div class="dist-card">
    ...
    <p style="font-size:11px;color:var(--muted);margin:10px 0 0;">Freeze locks payees permanently (required before deposits). Close Deposits ends investor period.</p>
  </div>
  <div id="distLog"></div>
</div>

<!-- TAB: Payees -->
<div id="tab-payees" class="dist-section">
  <div class="dist-card">
    <h3>👥 Set Payees</h3>
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:16px;flex-wrap:wrap;">
      <label style="font-size:12px;color:var(--muted);">Number of wallets:</label>
      <select class="dist-input" id="payeeCount" style="width:80px;margin:0;" onchange="buildPayeeRows()">
      ...
      <button class="dist-btn ghost" onclick="distributeEvenly()" style="font-size:11px;padding:5px 12px;">⚖️ Distribute Evenly</button>
    </div>
    <div style="display:grid;grid-template-columns:1fr 80px 50px;gap:8px;margin-bottom:6px;">
      <span style="font-size:10px;color:var(--muted);text-transform:uppercase;">Wallet Address</span>
      <span style="font-size:10px;color:var(--muted);text-transform:uppercase;text-align:center;">BPS</span>
      <span style="font-size:10px;color:var(--muted);text-transform:uppercase;text-align:right;">%</span>
    </div>
    <div id="payeeRows"></div>
    <div style="margin-top:12px;padding:8px 12px;background:rgba(124,58,237,.08);border-radius:6px;font-size:11px;color:var(--muted);">
      BPS = Basis Points &nbsp;|&nbsp; 10000 BPS = 100% &nbsp;|&nbsp; 5000 = 50% &nbsp;|&nbsp; 2500 = 25%
    </div>
    <button class="dist-btn primary" onclick="doSetPayees()" style="margin-top:12px;">✅ Set Payees on Contract</button>
  </div>
  <!-- Token Setup -->
  <div class="dist-card" style="border-color:rgba(251,191,36,.3);">
    <h3>🪙 Active ERC-20 Token</h3>
    <p style="font-size:11px;color:var(--muted);margin:0 0 10px;">Select the token clients will deposit — USDT, USDC, SIG, or any ERC-20.</p>
    <div style="display:flex;gap:8px;align-items:flex-end;flex-wrap:wrap;margin-bottom:8px;">
      <div style="flex:1;"><label style="font-size:11px;color:var(--muted);">Token Contract Address</label>
        <input class="dist-input" id="activeTokenAddr" placeholder="0x... paste address" style="margin:4px 0 0;border-color:rgba(251,191,36,.4);" oninput="clearTokenInfo()" /></div>
      <button class="dist-btn ghost" onclick="lookupToken()" style="margin-bottom:8px;border-color:rgba(251,191,36,.4);color:#fbbf24;">🔍 Lookup</button>
    </div>
    <div id="tokenInfoBox" style="display:none;margin-bottom:10px;padding:10px 14px;background:rgba(251,191,36,.06);border:1px solid rgba(251,191,36,.25);border-radius:8px;">
    ...
    <div id="tokenInfoError" style="display:none;margin-bottom:8px;font-size:12px;color:#f87171;"></div>
    <div>
      <span style="font-size:10px;color:var(--muted);text-transform:uppercase;letter-spacing:.05em;">Quick Select:</span>
      <div style="display:flex;gap:6px;flex-wrap:wrap;margin-top:6px;">
        <button class="dist-btn ghost" onclick="setPresetToken('0xdac17f958d2ee523a2206206994597c13d831ec7','USDT')" style="font-size:11px;padding:5px 10px;">USDT (ETH)</button>
        <button class="dist-btn ghost" onclick="setPresetToken('0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48','USDC')" style="font-size:11px;padding:5px 10px;">USDC (ETH)</button>
        <button class="dist-btn ghost" onclick="setPresetToken('0x55d398326f99059ff775485246999027b3197955','USDT-BSC')" style="font-size:11px;padding:5px 10px;">USDT (BSC)</button>
        <button class="dist-btn ghost" onclick="setPresetToken('0x8ac76a51cc950d9822d68b83fe1ad97b32cd580d','USDC-BSC')" style="font-size:11px;padding:5px 10px;">USDC (BSC)</button>
        <button class="dist-btn ghost" onclick="setPresetToken('0xc2ac880e474c3576cc3afb7c560e402ce24d5b37','SIG')" style="font-size:11px;padding:5px 10px;border-color:rgba(167,139,250,.5);color:#a78bfa;">SIG Token</button>
      </div>
    </div>
  </div>
</div>
...
<!-- TAB: Deposit -->
<div id="tab-deposit" class="dist-section">
  <div class="dist-card">
    <h3>💰 Deposit Funds into Contract</h3>
    <div class="dist-grid">
      <div>
        <label style="font-size:11px;color:var(--muted);display:block;margin-bottom:6px;">Deposit Native ETH/BNB</label>
        <input class="dist-input" id="nativeAmount" placeholder="Amount in ETH (e.g. 0.1)" />
        <button class="dist-btn success" onclick="doDepositNative()">⬇️ Deposit Native</button>
      </div>
      <div>
        <label style="font-size:11px;color:var(--muted);display:block;margin-bottom:6px;">Deposit ERC-20 Token — <span id="depositTokenLabel" style="color:#fbbf24;">select in Payees tab</span></label>
        <div style="padding:7px 10px;background:rgba(251,191,36,.05);border:1px solid rgba(251,191,36,.2);border-radius:6px;margin-bottom:8px;font-size:11px;color:var(--muted);">
        ...
        <button class="dist-btn success" onclick="doDepositToken()">⬇️ Approve & Deposit</button>
      </div>
    </div>
  </div>
  <!-- Generate deposit link -->
  <div class="dist-card" style="border-color:rgba(124,58,237,.3);">
    <h3>🔗 Generate Investor Deposit Link</h3>
    <p style="font-size:11px;color:var(--muted);margin:0 0 12px;">Share a link with investors so they can deposit directly to the contract via their own MetaMask.</p>
    <div class="dist-grid" style="margin-bottom:12px;">
      <div class="otp-field">
        <label style="font-size:11px;color:var(--muted);">Investor Wallet</label>
        <input class="dist-input" id="invWallet" placeholder="0x..." />
      </div>
      <div class="otp-field">
        <label style="font-size:11px;color:var(--muted);">Network</label>
        <select class="dist-input" id="invNetwork"><option value="ethereum">Ethereum</option><option value="bsc" selected>BSC</option></select>
      </div>
    </div>
    <button class="dist-btn primary" onclick="genInvestorLink()">🔗 Generate Link</button>
    <div id="invLinkBox" style="display:none;margin-top:12px;padding:10px 14px;background:rgba(124,58,237,.08);border:1px solid rgba(124,58,237,.3);border-radius:8px;word-break:break-all;font-size:11px;color:#c4b5fd;"></div>
  </div>
</div>

<!-- TAB: Claim -->
<div id="tab-claim" class="dist-section">
  <div class="dist-card">
    <h3>🏦 Claim Your Share</h3>
    <div class="dist-grid">
      <div>
        <label style="font-size:11px;color:var(--muted);display:block;margin-bottom:8px;">Claimable ETH/BNB</label>
        <div class="dist-stat" style="margin-bottom:10px;"><span class="val" id="claimableNative">—</span> <span style="font-size:11px;color:var(--muted);">native</span></div>
        <button class="dist-btn primary" onclick="doClaimNative()">💎 Claim Native</button>
      </div>
      <div>
        <label style="font-size:11px;color:var(--muted);display:block;margin-bottom:8px;">Claimable Token — <span id="claimTokenLabel" style="color:#fbbf24;">select in Payees tab</span></label>
        <div style="padding:7px 10px;background:rgba(251,191,36,.05);border:1px solid rgba(251,191,36,.2);border-radius:6px;margin-bottom:8px;font-size:11px;color:var(--muted);">
          Token: <code id="claimTokenAddrDisplay" style="color:#fbbf24;">not set</code>
        </div>
        <div class="dist-stat" style="margin-bottom:10px;"><span class="val" id="claimableToken">—</span> <span id="claimableTokenSymbol" style="font-size:11px;color:var(--muted);">tokens</span></div>
        <button class="dist-btn ghost" onclick="checkClaimableToken()" style="margin-right:6px;">🔍 Check</button>
        <button class="dist-btn success" onclick="doClaimToken()">💎 Claim Token</button>
      </div>
    </div>
  </div>
</div>
...
<!-- TAB: Registry -->
<div id="tab-registry" class="dist-section">
  <div class="dist-card" style="border-color:rgba(251,191,36,.3);">
    <h3>🗂 Multi-Currency Contract Registry</h3>
    <p style="font-size:11px;color:var(--muted);margin:0 0 12px;">Save a SIGProfitDistributor contract for each currency. Click Load to switch the active contract.</p>
    <div id="regRows" style="display:flex;flex-direction:column;gap:8px;margin-bottom:12px;"></div>
    <div style="display:flex;gap:8px;flex-wrap:wrap;">
      <input class="dist-input" id="regCurrency" placeholder="Currency (e.g. EUR, USDT)" style="width:120px;margin:0;" />
      <input class="dist-input" id="regContract" placeholder="Contract address 0x..." style="flex:1;margin:0;" />
      <button class="dist-btn primary" onclick="saveRegistry()" style="white-space:nowrap;">💾 Save</button>
    </div>
  </div>
</div>
...
var DIST_ABI = [
  ...
  "function setPayees(address[] calldata wallets, uint256[] calldata bps) external",
  ...
  "function claimableNative(address wallet) external view returns (uint256)",
  "function claimableToken(address token, address wallet) external view returns (uint256)",
  "function sharesFrozen() external view returns (bool)",
  "function depositsClosed() external view returns (bool)",
  "function payeeCount() external view returns (uint256)",
  "function totalNativeReceived() external view returns (uint256)",
  "function trackedNativeBalance() external view returns (uint256)",
  "function getPayees() external view returns (address[] memory, uint256[] memory)",
  "function setActiveToken(address token) external",
...
var DIST_BYTECODE = "0x";  // Insert compiled bytecode if available; deploy via Remix otherwise

var activeTokenAddr = "";
var activeTokenDecimals = 18;
var activeTokenSymbol = "";
var registry = JSON.parse(localStorage.getItem('distRegistry') || '{}');
...
function switchTab(name) {
  document.querySelectorAll('.dist-section').forEach(function(s){s.classList.remove('active');});
...
async function connectWallet() {
  try {
    ...
    provider = new _ethers.BrowserProvider(window.ethereum);
    ...
    document.getElementById('walletBalance').textContent = parseFloat(_ethers.formatEther(bal)).toFixed(4) + ' native';
    document.getElementById('walletBalance').style.display = '';
    log('Wallet connected: ' + addr);
    var ca = document.getElementById('contractAddr').value.trim();
    if (ca) loadContractState();
  } catch(e) { log('Connect error: '+e.message); alert(e.message); }
}

async function switchNetwork() {
  var chainId = document.getElementById('networkSelect').value;
  if (!window.ethereum) return;
  try { await window.ethereum.request({method:'wallet_switchEthereumChain',params:[{chainId:'0x'+parseInt(chainId).toString(16)}]}); }
  catch(e) { log('Network switch: '+e.message); }
}

async function diagWallet() {
  var box = document.getElementById('diagBox');
  box.style.display = 'block';
  var lines = [];
  lines.push('MetaMask: ' + (window.ethereum ? '✅ Found' : '❌ Not found'));
  lines.push('ethers.js: ' + (window.ethers ? '✅ Loaded' : '❌ Not loaded'));
  if (window.ethereum && window.ethers) {
    try {
      var p = new _ethers.BrowserProvider(window.ethereum);
      var n = await p.getNetwork();
      lines.push('Network: ' + n.name + ' (chain ' + n.chainId + ')');
      var accounts = await window.ethereum.request({method:'eth_accounts'});
      lines.push('Accounts: ' + (accounts.length ? accounts[0] : 'none connected'));
    } catch(e) { lines.push('Network error: '+e.message); }
  }
  lines.push('Contract: ' + (document.getElementById('contractAddr').value.trim() || 'not set'));
...
async function deployContract() {
  ...
  var owner = document.getElementById('deployOwner').value.trim() || await signer.getAddress();
  document.getElementById('deployBtn').disabled = true;
  document.getElementById('deployStatus').textContent = 'Deploying…';
  log('Deploying SIGProfitDistributor with owner: ' + owner);
  try {
    var factory = new _ethers.ContractFactory(DIST_ABI, DIST_BYTECODE, signer);
    var deployed = await factory.deploy(owner);
    log('TX sent: ' + deployed.deploymentTransaction().hash);
    document.getElementById('deployStatus').textContent = 'Waiting for confirmation…';
    await deployed.waitForDeployment();
    var addr = await deployed.getAddress();
    ...
    document.getElementById('deployStatus').textContent = '✅ Done';
    var net = document.getElementById('networkSelect').value;
    var explorer = net==='1'?'https://etherscan.io':net==='56'?'https://bscscan.com':'https://testnet.bscscan.com';
    document.getElementById('deployExplorerLink').innerHTML = '<a href="'+explorer+'/address/'+addr+'" target="_blank" style="color:#7c3aed;">View on Explorer ↗</a>';
  } catch(e) { log('Deploy error: '+e.message); document.getElementById('deployStatus').textContent = '❌ Error'; alert(e.message); }
  document.getElementById('deployBtn').disabled = false;
}

function useDeployedContract() {
  document.getElementById('contractAddr').value = document.getElementById('deployedAddr').value;
  loadContractState();
}
...
async function loadContractState() {
  ...
  if (!provider) {
    try {
      var net = document.getElementById('networkSelect').value;
      var rpcMap = {'1':'https://rpc.ankr.com/eth','56':'https://bsc-dataseed.binance.org','97':'https://data-seed-prebsc-1-s1.binance.org:8545'};
      provider = new _ethers.JsonRpcProvider(rpcMap[net]||rpcMap['56']);
    } catch(e) { alert('Connect MetaMask or have a provider'); return; }
  }
  document.getElementById('contractStatus').textContent = 'Loading…';
  log('Loading contract state for '+addr);
  try {
    contract = new _ethers.Contract(addr, DIST_ABI, signer||provider);
    var [frozen, closed, count, totNative, trackedNative] = await Promise.all([
      contract.sharesFrozen(), contract.depositsClosed(), contract.payeeCount(),
      contract.totalNativeReceived(), contract.trackedNativeBalance()
    ]);
    document.getElementById('stSharesFrozen').textContent = frozen ? '✅ Yes' : '❌ No';
    document.getElementById('stDepositsClosed').textContent = closed ? '✅ Yes' : '❌ No';
    document.getElementById('stPayeeCount').textContent = count.toString();
    document.getElementById('stNativeReceived').textContent = parseFloat(_ethers.formatEther(totNative)).toFixed(6);
    document.getElementById('stNativeTracked').textContent = parseFloat(_ethers.formatEther(trackedNative)).toFixed(6);
    document.getElementById('stateCard').style.display = 'block';
    document.getElementById('contractStatus').textContent = '✅ Loaded';
    if (count > 0) {
      var [wallets, bps] = await contract.getPayees();
      var html = '<div style="margin-top:10px;"><div style="font-size:11px;color:var(--muted);text-transform:uppercase;margin-bottom:6px;">Payees</div>';
      for (var i=0;i<wallets.length;i++) {
        html += '<div style="display:flex;gap:10px;padding:6px 10px;background:rgba(255,255,255,.04);border-radius:6px;margin-bottom:4px;font-size:11px;">'
          +'<code style="flex:1;color:var(--muted);">'+wallets[i]+'</code>'
          +'<span style="font-weight:700;color:#a78bfa;">'+bps[i].toString()+' BPS ('+parseFloat(bps[i])/100+'%)</span></div>';
      }
      html += '</div>';
      document.getElementById('payeesList').innerHTML = html;
    }
    log('Contract loaded. Payees: '+count+', Frozen: '+frozen);
  } catch(e) { log('Load error: '+e.message); document.getElementById('contractStatus').textContent = '❌ Error'; }
}

// ─── Payees ──────────────────────────────────────────────────────────────────
function buildPayeeRows() {
  var n = parseInt(document.getElementById('payeeCount').value);
  var container = document.getElementById('payeeRows');
  var existing = container.querySelectorAll('.payee-row');
  var existingData = [];
  existing.forEach(function(row) {
    existingData.push({w:row.querySelector('.pw').value, b:row.querySelector('.bps-input').value});
  });
  container.innerHTML = '';
  for (var i=0;i<n;i++) {
    var row = document.createElement('div');
    row.className = 'payee-row';
    row.innerHTML = '<input class="pw" placeholder="0x wallet address" value="'+(existingData[i]?existingData[i].w:'')+'" onchange="updateBpsSum()" style="flex:1;background:rgba(255,255,255,.06);border:1px solid var(--border);border-radius:6px;padding:7px 10px;color:#f0f0f0;font-size:12px;font-family:monospace;" />'
      +'<input class="bps-input" type="number" min="0" max="10000" placeholder="BPS" value="'+(existingData[i]?existingData[i].b:'')+'" oninput="updateBpsSum()" style="width:80px;background:rgba(255,255,255,.06);border:1px solid var(--border);border-radius:6px;padding:7px 8px;color:#a78bfa;font-size:13px;font-weight:700;text-align:center;" />'
      +'<span class="bps-pct">—</span>';
...
function updateBpsSum() {
  var total = 0;
  document.querySelectorAll('.bps-input').forEach(function(inp, i) {
    var v = parseInt(inp.value)||0;
    total += v;
    var pct = inp.parentElement.querySelector('.bps-pct');
    if (pct) pct.textContent = (v/100).toFixed(1)+'%';
  });
  var lbl = document.getElementById('bpsSumLabel');
  lbl.textContent = 'Total: '+total+' / 10000 BPS';
  lbl.style.color = total===10000 ? '#34d399' : total>10000 ? '#f87171' : '#fbbf24';
}

function distributeEvenly() {
  var inputs = document.querySelectorAll('.bps-input');
  var n = inputs.length;
  if (!n) return;
  var each = Math.floor(10000/n);
  var remainder = 10000 - each*n;
  inputs.forEach(function(inp, i) {
    inp.value = i===0 ? each+remainder : each;
  });
  updateBpsSum();
}

async function doSetPayees() {
  if (!contract || !signer) { alert('Load contract and connect MetaMask first'); return; }
  var wallets=[], bps=[];
  var rows = document.querySelectorAll('.payee-row');
  rows.forEach(function(row) {
    var w = row.querySelector('.pw').value.trim();
    var b = parseInt(row.querySelector('.bps-input').value)||0;
    if (w && b > 0) { wallets.push(w); bps.push(b); }
  });
  var total = bps.reduce(function(a,b){return a+b;},0);
  if (total !== 10000) { alert('BPS must sum to exactly 10000. Current: '+total); return; }
  if (!wallets.length) { alert('Add at least one payee'); return; }
  log('Setting '+wallets.length+' payees…');
  try {
    var c = contract.connect(signer);
    var tx = await c.setPayees(wallets, bps);
    log('TX: '+tx.hash); await tx.wait();
    log('✅ Payees set successfully'); loadContractState();
  } catch(e) { log('Error: '+e.message); alert(e.message); }
}

// ─── Token ───────────────────────────────────────────────────────────────────
async function lookupToken() {
  var addr = document.getElementById('activeTokenAddr').value.trim();
  if (!addr) return;
  document.getElementById('tokenInfoError').style.display = 'none';
  document.getElementById('tokenInfoBox').style.display = 'none';
  if (!provider) { alert('Connect MetaMask first'); return; }
  try {
    var tok = new _ethers.Contract(addr, ERC20_ABI, provider);
    var [sym, dec, name] = await Promise.all([tok.symbol(), tok.decimals(), tok.name()]);
    activeTokenAddr = addr; activeTokenDecimals = Number(dec); activeTokenSymbol = sym;
    ...
    document.getElementById('depositTokenLabel').textContent = sym;
    document.getElementById('depositTokenAddrDisplay').textContent = addr.slice(0,10)+'…'+addr.slice(-6);
    document.getElementById('claimTokenLabel').textContent = sym;
    document.getElementById('claimTokenAddrDisplay').textContent = addr.slice(0,10)+'…'+addr.slice(-6);
    document.getElementById('claimableTokenSymbol').textContent = sym;
    log('Token: '+name+' ('+sym+') — '+dec+' decimals');
  } catch(e) {
    document.getElementById('tokenInfoError').textContent = 'Could not load token: '+e.message;
    document.getElementById('tokenInfoError').style.display = 'block';
  }
}

function setPresetToken(addr, sym) {
...
async function doDepositNative() {
  if (!contract||!signer){alert('Load contract and connect MetaMask');return;}
  var amt = document.getElementById('nativeAmount').value.trim();
  if (!amt){alert('Enter amount');return;}
  log('Depositing '+amt+' native…');
  try { var c=contract.connect(signer); var tx=await c.depositNative({value:_ethers.parseEther(amt)}); log('TX: '+tx.hash); await tx.wait(); log('✅ Deposit confirmed'); loadContractState(); }
  catch(e){log('Error: '+e.message);alert(e.message);}
}

async function doDepositToken() {
  if (!contract||!signer||!activeTokenAddr){alert('Load contract, connect MetaMask, and select a token');return;}
  var amt = document.getElementById('tokenAmount').value.trim();
  if (!amt){alert('Enter amount');return;}
  var amtWei = _ethers.parseUnits(amt, activeTokenDecimals);
  var contractAddr = document.getElementById('contractAddr').value.trim();
  log('Approving '+amt+' '+activeTokenSymbol+'…');
  try {
    var tok = new _ethers.Contract(activeTokenAddr, ERC20_ABI, signer);
    var appTx = await tok.approve(contractAddr, amtWei);
    log('Approve TX: '+appTx.hash); await appTx.wait(); log('Approved. Depositing…');
    var c=contract.connect(signer); var tx=await c.depositToken(activeTokenAddr, amtWei);
    log('Deposit TX: '+tx.hash); await tx.wait(); log('✅ Token deposit confirmed'); loadContractState();
  } catch(e){log('Error: '+e.message);alert(e.message);}
}
...
async function doClaimNative() {
  if (!contract||!signer){alert('Load contract and connect MetaMask');return;}
  log('Claiming native…');
  try { var c=contract.connect(signer); var tx=await c.claimNative(); log('TX: '+tx.hash); await tx.wait(); log('✅ Native claimed'); }
  catch(e){log('Error: '+e.message);alert(e.message);}
}

async function checkClaimableToken() {
  if (!contract||!signer||!activeTokenAddr){alert('Load contract, connect MetaMask, select token');return;}
  try {
    var addr=await signer.getAddress();
    var amt=await contract.claimableToken(activeTokenAddr,addr);
    var fmt=_ethers.formatUnits(amt,activeTokenDecimals);
    document.getElementById('claimableToken').textContent=fmt;
    log('Claimable '+activeTokenSymbol+': '+fmt);
  } catch(e){log('Error: '+e.message);}
}

async function doClaimToken() {
  if (!contract||!signer||!activeTokenAddr){alert('Load contract, connect MetaMask, select token');return;}
  log('Claiming '+activeTokenSymbol+'…');
  try { var c=contract.connect(signer); var tx=await c.claimToken(activeTokenAddr); log('TX: '+tx.hash); await tx.wait(); log('✅ Token claimed'); }
  catch(e){log('Error: '+e.message);alert(e.message);}
}

async function doFreezeShares() {
  if (!contract||!signer){alert('Load contract and connect MetaMask');return;}
  if (!confirm('Freeze shares? This is irreversible.')) return;
  log('Freezing shares…');
  try { var c=contract.connect(signer); var tx=await c.freezeShares(); log('TX: '+tx.hash); await tx.wait(); log('✅ Shares frozen'); loadContractState(); }
  catch(e){log('Error: '+e.message);alert(e.message);}
}

async function doCloseDeposits() {
  if (!contract||!signer){alert('Load contract and connect MetaMask');return;}
  if (!confirm('Close deposits? Claims remain open. Deploy new distributor for future profits.')) return;
  log('Closing deposits…');
  try { var c=contract.connect(signer); var tx=await c.closeDeposits(); log('TX: '+tx.hash); await tx.wait(); log('✅ Deposits closed'); loadContractState(); }
  catch(e){log('Error: '+e.message);alert(e.message);}
}
...
function genInvestorLink() {
  ...
  var investor = document.getElementById('invWallet').value.trim();
  var network  = document.getElementById('invNetwork').value;
  if (!contract) { alert('Enter contract address first'); return; }
  if (!investor) { alert('Enter investor wallet address'); return; }
...
function saveRegistry() {
  var cur = document.getElementById('regCurrency').value.trim().toUpperCase();
  var addr = document.getElementById('regContract').value.trim();
  if (!cur||!addr) { alert('Enter currency and contract address'); return; }
  registry[cur] = addr;
  localStorage.setItem('distRegistry', JSON.stringify(registry));
  renderRegistry();
  document.getElementById('regCurrency').value='';
  document.getElementById('regContract').value='';
}

function loadRegistryContract(currency) {
  document.getElementById('contractAddr').value = registry[currency];
  switchTab('blockchain');
  document.querySelectorAll('.dist-tab')[0].classList.add('active');
  loadContractState();
}

function deleteRegistry(currency) {
  if (!confirm('Remove '+currency+' from registry?')) return;
  delete registry[currency];
  localStorage.setItem('distRegistry', JSON.stringify(registry));
  renderRegistry();
}

// ─── Profit Overview ─────────────────────────────────────────────────────────
function loadProfitOverview() {
  Promise.all([
    api('/api/v1/admin/tokenization-jobs?limit=1000').catch(function(){return{jobs:[]};}),
    api('/api/v1/admin/outbound-transfers?limit=1000').catch(function(){return{transfers:[]};}),
    api('/api/v1/admin/otc/quotes?limit=1000').catch(function(){return{quotes:[]};}),
    api('/api/v1/admin/fiat/deposits?limit=1000').catch(function(){return{deposits:[]};}),
  ]).then(function(results) {
    var jobs = results[0].jobs||[];
    var xfers = results[1].transfers||[];
    var quotes = results[2].quotes||[];
    var deposits = results[3].deposits||[];

    var totalEur = 0;
    jobs.filter(function(j){return j.status==='COMPLETED';}).forEach(function(j){totalEur+=parseFloat(j.amount_eur||0);});
    deposits.filter(function(d){return d.status==='CONFIRMED';}).forEach(function(d){totalEur+=parseFloat(d.amount_eur||0);});

    var totalSig = jobs.filter(function(j){return j.status==='COMPLETED';})
      .reduce(function(sum,j){return sum+parseFloat(j.usdt_amount||j.sig_amount||0);},0);

    var totalUsdt = xfers.filter(function(x){return x.status==='COMPLETED';})
      .reduce(function(sum,x){return sum+parseFloat(x.amount_usdt||x.amount||0);},0);

    var completedQuotes = quotes.filter(function(q){return q.status==='EXECUTED';}).length;

    document.getElementById('pEur').textContent = totalEur.toLocaleString('en', {minimumFractionDigits:2, maximumFractionDigits:2}) + ' EUR';
    document.getElementById('pSig').textContent = totalSig.toLocaleString('en', {minimumFractionDigits:2, maximumFractionDigits:2}) + ' SIG';
    document.getElementById('pUsdt').textContent = totalUsdt.toLocaleString('en', {minimumFractionDigits:2, maximumFractionDigits:2}) + ' USDT';
    document.getElementById('pQuotes').textContent = completedQuotes;
  }).catch(function(e){console.warn('Overview error:',e);});
}

function calcDistribution() {
  var rows = document.querySelectorAll('.payee-row');
  if (!rows.length) {
    document.getElementById('calcResult').innerHTML = '<span style="color:#fbbf24;">⚠️ Add payees in the Payees tab first to calculate shares.</span>';
    document.getElementById('calcResult').style.display = 'block';
    return;
  }
  var totalUsdt = parseFloat((document.getElementById('pUsdt').textContent||'0').replace(/[^0-9.]/g,''))||0;
  if (!totalUsdt) {
    document.getElementById('calcResult').innerHTML = '<span style="color:#fbbf24;">⚠️ Load profit stats first (click Refresh Stats).</span>';
    document.getElementById('calcResult').style.display = 'block';
    return;
  }
  var html = '<div style="font-weight:700;color:var(--gold);margin-bottom:8px;">💎 Distribution Calculation (Total: '+totalUsdt.toFixed(2)+' USDT)</div>';
  rows.forEach(function(row, i) {
    var w = row.querySelector('.pw').value.trim() || '(wallet '+(i+1)+')';
    var b = parseInt(row.querySelector('.bps-input').value)||0;
    var share = (totalUsdt * b / 10000).toFixed(2);
    html += '<div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid rgba(255,255,255,.06);">'
      +'<code style="font-size:10px;color:var(--muted);">'+w.slice(0,16)+'…'+'</code>'
      +'<span style="color:#34d399;font-weight:700;">'+share+' USDT</span>'
      +'<span style="color:var(--muted);font-size:11px;">'+(b/100).toFixed(1)+'%</span></div>';
  });
...
async def dashboard_nowpayments(request: Request):
    ...
    body = """
<style>
.np-tabs{display:flex;gap:4px;margin-bottom:20px;background:var(--glass);border:1px solid var(--glass-border);border-radius:10px;padding:5px;width:fit-content;}
.np-tab-btn{padding:8px 18px;border:none;background:none;border-radius:7px;cursor:pointer;font-size:12.5px;font-weight:600;color:var(--muted);transition:.15s;}
.np-tab-btn.active{background:var(--brand);color:#fff;}
.np-pane{display:none;}.np-pane.active{display:block;}
.np-result{margin-top:14px;background:rgba(0,0,0,.25);border:1px solid var(--glass-border);border-radius:8px;padding:14px;display:none;}
.np-result pre{margin:0;font-size:11.5px;color:var(--ink);white-space:pre-wrap;word-break:break-all;font-family:monospace;}
.addr-box{background:rgba(14,165,233,.08);border:1px solid rgba(14,165,233,.3);border-radius:8px;padding:12px 16px;margin-top:10px;display:none;}
.addr-box .addr{font-family:monospace;font-size:13px;color:#38bdf8;word-break:break-all;font-weight:700;}
.addr-box .lbl{font-size:11px;color:var(--muted);margin-bottom:4px;}
</style>
<div class="page-body">

<div id="configWarning" style="display:none;background:rgba(245,158,11,.12);border:1px solid rgba(245,158,11,.3);border-radius:8px;padding:10px 16px;font-size:12.5px;color:#f59e0b;margin-bottom:14px;">
  ⚠️ NOWPayments API key not configured. Add <code>NOWPAYMENTS_API_KEY</code> to Render environment variables.
</div>

<div style="display:flex;align-items:center;gap:12px;margin-bottom:18px;">
  <span id="npStatus" style="font-size:12.5px;color:var(--muted);">Checking API…</span>
  <button class="btn btn-ghost" style="font-size:11px;padding:5px 12px;" onclick="checkStatus()">🔄 Refresh</button>
</div>

<div class="np-tabs">
  <button class="np-tab-btn active" onclick="switchTab('payments')">💳 Receive Payment</button>
  <button class="np-tab-btn" onclick="switchTab('invoice')">🔗 Invoice Link</button>
  <button class="np-tab-btn" onclick="switchTab('payout')">📤 Mass Payout</button>
  <button class="np-tab-btn" onclick="switchTab('estimate')">📊 Estimate</button>
  <button class="np-tab-btn" onclick="switchTab('history')">📋 Payment History</button>
</div>

<!-- ── RECEIVE PAYMENT ── -->
<div id="tab-payments" class="np-pane active">
  <div class="panel">
    <div class="panel-head"><h3>Create Crypto Payment</h3></div>
    <div style="padding:16px 18px;">
      <div class="form-grid">
        <div class="form-field"><label>Amount</label><input id="pp_amount" type="number" step="0.01" placeholder="100.00"/></div>
        <div class="form-field"><label>Price Currency (fiat)</label><input id="pp_price_currency" value="usd" placeholder="usd / eur"/></div>
        <div class="form-field"><label>Pay Currency (crypto)</label>
        ...
        <div class="form-field"><label>Order ID (optional)</label><input id="pp_order_id" placeholder="ORD-001"/></div>
        <div class="form-field" style="grid-column:1/-1;"><label>Description (optional)</label><input id="pp_description" placeholder="Payment for services"/></div>
        <div class="form-field"><label>IPN Callback URL (optional)</label><input id="pp_ipn" placeholder="https://api.alshumookh-pay.com/admin/nowpayments/ipn-webhook"/></div>
        <div class="form-field"><label>Success URL (optional)</label><input id="pp_success" placeholder="https://…/success"/></div>
        <div class="form-field"><label style="display:flex;align-items:center;gap:10px;margin-top:20px;"><input type="checkbox" id="pp_fixed_rate"/> Fixed Rate &nbsp;<input type="checkbox" id="pp_fee_by_user"/> Fee paid by user</label></div>
      </div>
      <div style="margin-top:16px;"><button class="btn btn-primary" onclick="createPayment()">Create Payment Invoice</button></div>
      <div id="pp_result" class="np-result">
        <div id="pp_addr_box" class="addr-box">
  ...
  <div class="panel" style="margin-top:14px;">
    <div class="panel-head"><h3>Check Payment Status</h3></div>
    <div style="padding:16px 18px;display:flex;gap:10px;">
      <input id="ps_id" placeholder="Payment ID…" style="flex:1;background:var(--panel-solid);border:1px solid var(--line-strong);border-radius:8px;padding:8px 12px;color:var(--ink);font-size:13px;"/>
      <button class="btn btn-primary" onclick="checkPaymentStatus()">Check</button>
    </div>
    <div id="ps_result" class="np-result" style="margin:0 18px 16px;"></div>
  </div>
</div>

<!-- ── INVOICE ── -->
<div id="tab-invoice" class="np-pane">
  <div class="panel">
    <div class="panel-head"><h3>Create Hosted Invoice Link</h3></div>
    <div style="padding:16px 18px;">
      <p style="font-size:12.5px;color:var(--muted);margin:0 0 14px;">The client receives a URL, opens it, and pays with their preferred crypto — no address handling on your side.</p>
      <div class="form-grid">
        <div class="form-field"><label>Amount</label><input id="iv_amount" type="number" step="0.01" placeholder="250.00"/></div>
        <div class="form-field"><label>Price Currency</label><input id="iv_currency" value="usd" placeholder="usd / eur"/></div>
        <div class="form-field"><label>Order ID (optional)</label><input id="iv_order_id" placeholder="INV-2025-001"/></div>
        <div class="form-field"><label>Description (optional)</label><input id="iv_description" placeholder="Invoice for…"/></div>
        <div class="form-field"><label>IPN Callback URL (optional)</label><input id="iv_ipn" placeholder="https://api.alshumookh-pay.com/admin/nowpayments/ipn-webhook"/></div>
        <div class="form-field"><label>Success URL (optional)</label><input id="iv_success" placeholder="https://…/success"/></div>
        <div class="form-field"><label>Cancel URL (optional)</label><input id="iv_cancel" placeholder="https://…/cancel"/></div>
      </div>
      <div style="margin-top:16px;"><button class="btn btn-success" onclick="createInvoice()">Generate Invoice Link</button></div>
      <div id="iv_result" class="np-result">
        <div id="iv_link_box" style="display:none;margin-bottom:12px;background:rgba(16,185,129,.08);border:1px solid rgba(16,185,129,.3);border-radius:8px;padding:12px 16px;">
          <div style="font-size:12px;color:#10b981;margin-bottom:6px;font-weight:700;">✅ Invoice Created — Share this link:</div>
          <a id="iv_link" href="#" target="_blank" style="font-size:13px;color:#38bdf8;word-break:break-all;font-family:monospace;"></a>
          <button class="btn" style="margin-left:12px;padding:5px 12px;font-size:11px;background:rgba(201,168,76,.15);color:#c9a84c;border-color:rgba(201,168,76,.3);" onclick="copyInvoiceLink()">📋 Copy</button>
        </div>
        <pre id="iv_raw"></pre>
      </div>
    </div>
...
<!-- ── MASS PAYOUT ── -->
<div id="tab-payout" class="np-pane">
  <div class="panel">
    <div class="panel-head"><h3>Mass Payout (Multiple Recipients)</h3></div>
    <div style="padding:16px 18px;">
      <p style="font-size:12.5px;color:var(--muted);margin:0 0 14px;">Send crypto to multiple addresses in one API call. Requires Payouts API enabled in your NOWPayments account.</p>
      <div id="payout_rows">
        <div class="payout-row" style="display:grid;grid-template-columns:2fr 1fr 1fr auto;gap:10px;margin-bottom:10px;align-items:end;">
          <div class="form-field" style="margin:0;"><label>Wallet Address</label><input class="po_addr" placeholder="0x… or T…"/></div>
          <div class="form-field" style="margin:0;"><label>Currency</label>
            <select class="po_curr">
              <option value="usdterc20">USDT ERC-20</option><option value="usdttrc20">USDT TRC-20</option>
              <option value="usdtbsc">USDT BSC</option><option value="usdcerc20">USDC ERC-20</option>
              <option value="btc">BTC</option><option value="eth">ETH</option>
            </select>
          </div>
          <div class="form-field" style="margin:0;"><label>Amount</label><input class="po_amt" type="number" step="0.01" placeholder="100.00"/></div>
          <button class="btn btn-danger" style="font-size:11px;padding:5px 10px;" onclick="this.closest('.payout-row').remove()">✕</button>
        </div>
      </div>
      <div style="display:flex;gap:10px;margin-top:8px;">
        <button class="btn btn-ghost" onclick="addPayoutRow()">+ Add Recipient</button>
        <button class="btn btn-primary" onclick="createPayout()">Send Mass Payout</button>
      </div>
      <div id="po_result" class="np-result"></div>
    </div>
  </div>
  <div class="panel" style="margin-top:14px;">
    <div class="panel-head"><h3>Check Payout Status</h3></div>
    <div style="padding:16px 18px;display:flex;gap:10px;">
      <input id="pos_id" placeholder="Payout batch ID…" style="flex:1;background:var(--panel-solid);border:1px solid var(--line-strong);border-radius:8px;padding:8px 12px;color:var(--ink);font-size:13px;"/>
      <button class="btn btn-primary" onclick="checkPayoutStatus()">Check</button>
    </div>
    <div id="pos_result" class="np-result" style="margin:0 18px 16px;"></div>
  </div>
</div>

<!-- ── ESTIMATE ── -->
<div id="tab-estimate" class="np-pane">
  <div class="panel">
    <div class="panel-head"><h3>Currency Estimate / Auto-Conversion</h3></div>
    <div style="padding:16px 18px;">
      <p style="font-size:12.5px;color:var(--muted);margin:0 0 14px;">Calculate how much of one currency you receive for an amount of another.</p>
      <div class="form-grid">
        <div class="form-field"><label>Amount</label><input id="est_amount" type="number" step="0.01" placeholder="100"/></div>
        <div class="form-field"><label>From Currency</label><input id="est_from" placeholder="usd / btc / eth"/></div>
        <div class="form-field"><label>To Currency</label><input id="est_to" placeholder="usdterc20 / eth / btc"/></div>
      </div>
      <div style="margin-top:16px;"><button class="btn btn-primary" onclick="runEstimate()">Calculate</button></div>
      <div id="est_result" class="np-result">
        <div id="est_summary" style="font-size:15px;font-weight:700;color:var(--gold);margin-bottom:10px;"></div>
        <pre id="est_raw"></pre>
      </div>
    </div>
  </div>
...
<!-- ── HISTORY ── -->
<div id="tab-history" class="np-pane">
  <div class="panel">
    <div class="panel-head">
      <h3>Payment History</h3>
      <div style="display:flex;gap:8px;align-items:center;">
        <select id="hist_limit" style="background:var(--panel-solid);border:1px solid var(--line-strong);border-radius:8px;padding:6px 10px;color:var(--ink);font-size:12px;">
          <option value="10">10 rows</option><option value="20" selected>20 rows</option><option value="50">50 rows</option>
        </select>
        <button class="btn btn-primary" style="font-size:12px;padding:6px 14px;" onclick="loadHistory()">Load Payments</button>
      </div>
    </div>
    <div id="hist_content" style="padding:16px 18px;">
      <p style="color:var(--muted);font-size:13px;">Click "Load Payments" to fetch from NOWPayments.</p>
    </div>
  </div>
</div>
...
<script>
function switchTab(name) {
  var tabs=['payments','invoice','payout','estimate','history'];
...
async function createPayment(){
  try{
    var body={price_amount:parseFloat(document.getElementById('pp_amount').value),price_currency:document.getElementById('pp_price_currency').value.trim()||'usd',pay_currency:document.getElementById('pp_pay_currency').value,order_id:document.getElementById('pp_order_id').value||undefined,order_description:document.getElementById('pp_description').value||undefined,ipn_callback_url:document.getElementById('pp_ipn').value||undefined,success_url:document.getElementById('pp_success').value||undefined,is_fixed_rate:document.getElementById('pp_fixed_rate').checked,is_fee_paid_by_user:document.getElementById('pp_fee_by_user').checked};
    var d=await npApi('/nowpayments/create-payment',{method:'POST',body:JSON.stringify(body)});
    showNpResult('pp_result',d);
    if(d.pay_address){document.getElementById('pp_addr_box').style.display='block';document.getElementById('pp_pay_addr').textContent=d.pay_address;document.getElementById('pp_pay_amount').textContent=(d.pay_amount||'')+' '+(d.pay_currency||'').toUpperCase();document.getElementById('pp_pay_status').textContent=d.payment_status||'';document.getElementById('pp_pay_id').textContent=d.payment_id||'';}
    document.getElementById('pp_raw').textContent=JSON.stringify(d,null,2);
  }catch(e){showNpError('pp_result',e.message);}
}
async function checkPaymentStatus(){
  var id=document.getElementById('ps_id').value.trim(); if(!id)return;
  try{var d=await npApi('/nowpayments/payment/'+id);showNpResult('ps_result',d);document.getElementById('ps_result').innerHTML='<pre>'+JSON.stringify(d,null,2)+'</pre>';}catch(e){showNpError('ps_result',e.message);}
}
async function createInvoice(){
  try{
    var body={price_amount:parseFloat(document.getElementById('iv_amount').value),price_currency:document.getElementById('iv_currency').value.trim()||'usd',order_id:document.getElementById('iv_order_id').value||undefined,order_description:document.getElementById('iv_description').value||undefined,ipn_callback_url:document.getElementById('iv_ipn').value||undefined,success_url:document.getElementById('iv_success').value||undefined,cancel_url:document.getElementById('iv_cancel').value||undefined};
    var d=await npApi('/nowpayments/create-invoice',{method:'POST',body:JSON.stringify(body)});
    document.getElementById('iv_result').style.display='block';
    if(d.invoice_url){var lb=document.getElementById('iv_link_box');lb.style.display='block';var a=document.getElementById('iv_link');a.href=d.invoice_url;a.textContent=d.invoice_url;}
    document.getElementById('iv_raw').textContent=JSON.stringify(d,null,2);
  }catch(e){showNpError('iv_result',e.message);}
}
function copyInvoiceLink(){ navigator.clipboard.writeText(document.getElementById('iv_link').href).then(function(){showToast('Link copied!','ok');}); }
function addPayoutRow(){ var c=document.getElementById('payout_rows');var tpl=c.querySelector('.payout-row').cloneNode(true);tpl.querySelectorAll('input').forEach(function(i){i.value='';});c.appendChild(tpl); }
async function createPayout(){
  var rows=document.querySelectorAll('.payout-row'),withdrawals=[];
  rows.forEach(function(row){var addr=row.querySelector('.po_addr').value.trim(),curr=row.querySelector('.po_curr').value,amt=parseFloat(row.querySelector('.po_amt').value);if(addr&&curr&&amt>0)withdrawals.push({address:addr,currency:curr,amount:amt});});
  if(!withdrawals.length){showToast('Add at least one valid recipient','error');return;}
  try{var d=await npApi('/nowpayments/create-payout',{method:'POST',body:JSON.stringify({withdrawals:withdrawals})});showNpResult('po_result',d);document.getElementById('po_result').innerHTML='<pre>'+JSON.stringify(d,null,2)+'</pre>';}catch(e){showNpError('po_result',e.message);}
}
async function checkPayoutStatus(){
  var id=document.getElementById('pos_id').value.trim();if(!id)return;
  try{var d=await npApi('/nowpayments/payout/'+id);document.getElementById('pos_result').style.display='block';document.getElementById('pos_result').innerHTML='<pre>'+JSON.stringify(d,null,2)+'</pre>';}catch(e){showNpError('pos_result',e.message);}
}
async function runEstimate(){
  try{
    var body={amount:parseFloat(document.getElementById('est_amount').value),currency_from:document.getElementById('est_from').value.trim(),currency_to:document.getElementById('est_to').value.trim()};
    var d=await npApi('/nowpayments/estimate',{method:'POST',body:JSON.stringify(body)});
    document.getElementById('est_result').style.display='block';
    var est=d.estimated_amount!==undefined?d.estimated_amount:(d.amount_to!==undefined?d.amount_to:'—');
    document.getElementById('est_summary').textContent=body.amount+' '+body.currency_from.toUpperCase()+' ≈ '+est+' '+body.currency_to.toUpperCase();
    document.getElementById('est_raw').textContent=JSON.stringify(d,null,2);
  }catch(e){showNpError('est_result',e.message);}
}
async function loadHistory(){
  var limit=document.getElementById('hist_limit').value;
  document.getElementById('hist_content').innerHTML='<p style="color:var(--muted);">Loading…</p>';
  try{
    var d=await npApi('/nowpayments/payments?limit='+limit+'&page=0');
    var payments=d.data||d.result||[];
    if(!payments.length){document.getElementById('hist_content').innerHTML='<p style="color:var(--muted);">No payments found.</p>';return;}
    var sb=function(s){var m={finished:'#10b981',confirmed:'#10b981',sending:'#8b5cf6',confirming:'#f59e0b',waiting:'#f59e0b',partially_paid:'#f59e0b',failed:'#ef4444',expired:'#ef4444',refunded:'#ef4444'};var c=m[(s||'').toLowerCase()]||'#6b7280';return '<span style="display:inline-block;padding:2px 8px;border-radius:20px;background:'+c+'22;color:'+c+';border:1px solid '+c+'44;font-size:11px;font-weight:700;">'+(s||'—')+'</span>';};
    var rows=payments.map(function(p){return '<tr><td><code style="font-size:11px;">'+(p.payment_id||'—')+'</code></td><td>'+(p.order_id||'—')+'</td><td>'+sb(p.payment_status)+'</td><td>'+(p.price_amount||'')+' '+(p.price_currency||'').toUpperCase()+'</td><td>'+(p.pay_amount||'')+' '+(p.pay_currency||'').toUpperCase()+'</td><td>'+(p.actually_paid||'0')+' '+(p.pay_currency||'').toUpperCase()+'</td><td style="font-size:11px;">'+(p.created_at?new Date(p.created_at).toLocaleString():'—')+'</td><td><button class="btn" style="font-size:10px;padding:3px 8px;" data-pid="'+(p.payment_id||'')+'" onclick="copyText(this.dataset.pid)">📋</button></td></tr>';}).join('');
    document.getElementById('hist_content').innerHTML='<div class="table-wrap"><table><thead><tr><th>Payment ID</th><th>Order ID</th><th>Status</th><th>Price</th><th>Pay Amount</th><th>Received</th><th>Created</th><th></th></tr></thead><tbody>'+rows+'</tbody></table></div>';
  }catch(e){document.getElementById('hist_content').innerHTML='<p style="color:#ef4444;">❌ '+e.message+'</p>';}
}
checkStatus();
</script>
"""
...
# ─── Wallet Verify OTP Page ───────────────────────────────────────────────────

_WALLET_OTP_BODY = """
<div class="page-body">
<style>
.otp-card{background:var(--surface);border:1px solid var(--border);border-radius:12px;padding:22px;margin-bottom:18px;}
.otp-card h3{font-size:13px;font-weight:700;color:var(--gold);margin:0 0 14px;text-transform:uppercase;letter-spacing:.06em;}
.otp-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px;}
@media(max-width:640px){.otp-grid{grid-template-columns:1fr;}}
.otp-field{display:flex;flex-direction:column;gap:5px;}
.otp-field label{font-size:11px;color:var(--muted);text-transform:uppercase;letter-spacing:.04em;}
.otp-input{background:rgba(255,255,255,.06);border:1px solid var(--border);border-radius:8px;padding:10px 13px;color:#f0f0f0;font-size:13px;width:100%;box-sizing:border-box;}
.otp-input:focus{outline:none;border-color:#7c3aed;}
.otp-btn{display:inline-flex;align-items:center;gap:7px;padding:10px 20px;border-radius:8px;font-size:13px;font-weight:600;cursor:pointer;border:none;transition:.18s;}
.otp-btn.primary{background:linear-gradient(135deg,#7c3aed,#6d28d9);color:#fff;}
.otp-btn.success{background:linear-gradient(135deg,#059669,#047857);color:#fff;}
.otp-btn.danger{background:linear-gradient(135deg,#dc2626,#b91c1c);color:#fff;}
.otp-btn.ghost{background:rgba(255,255,255,.07);color:#e5e7eb;border:1px solid var(--border);}
.otp-btn:disabled{opacity:.45;cursor:not-allowed;}
.otp-badge{display:inline-block;padding:2px 9px;border-radius:999px;font-size:11px;font-weight:700;}
.otp-badge.verified{background:rgba(5,150,105,.2);color:#34d399;}
.otp-badge.pending{background:rgba(217,119,6,.2);color:#fbbf24;}
.otp-badge.expired{background:rgba(100,116,139,.15);color:#94a3b8;}
.otp-badge.failed{background:rgba(220,38,38,.2);color:#f87171;}
.otp-toast{position:fixed;top:18px;right:18px;z-index:9999;padding:12px 20px;border-radius:10px;font-size:13px;font-weight:600;max-width:340px;box-shadow:0 4px 20px rgba(0,0,0,.4);}
</style>

<!-- Step 1: Send OTP -->
<div class="otp-card" style="border-color:rgba(124,58,237,.5);background:rgba(124,58,237,.05);">
  <h3>📤 Step 1 — Send OTP to Recipient</h3>
  <p style="font-size:12px;color:var(--muted);margin:0 0 16px;">Enter the recipient wallet address and their WhatsApp number. A 6-digit code will be sent via WhatsApp.</p>
  <div class="otp-grid" style="margin-bottom:14px;">
    <div class="otp-field" style="grid-column:1 / -1;">
      <label>Wallet Address *</label>
      <input class="otp-input" id="reqWallet" placeholder="0x... (Ethereum) or T... (TRON)" />
    </div>
    <div class="otp-field">
      <label>WhatsApp Phone Number *</label>
      <input class="otp-input" id="reqPhone" placeholder="971501234567 (no + or spaces)" />
    </div>
    <div class="otp-field">
      <label>Notes (optional)</label>
      <input class="otp-input" id="reqNotes" placeholder="e.g. Client: Ahmed — Transfer #TRQ-001" />
    </div>
  </div>
  <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;">
    <button class="otp-btn primary" onclick="sendOtp()" id="sendBtn">📲 Send OTP via WhatsApp</button>
    <span id="sendStatus" style="font-size:12px;color:var(--muted);"></span>
  </div>
  <div id="sentBox" style="display:none;margin-top:14px;padding:14px 16px;background:rgba(5,150,105,.08);border:1px solid rgba(5,150,105,.3);border-radius:8px;">
    <p style="font-size:12px;font-weight:700;color:#34d399;margin:0 0 6px;">✅ OTP Sent — waiting for recipient to share the code</p>
    <div style="font-size:11px;color:var(--muted);">OTP ID: <code id="sentOtpId" style="color:#c4b5fd;"></code></div>
    <div style="font-size:11px;color:var(--muted);">Wallet: <code id="sentWallet" style="color:#c4b5fd;word-break:break-all;"></code></div>
    <div style="font-size:11px;color:var(--muted);">Expires: <span id="sentExpiry"></span></div>
  </div>
</div>

<!-- Step 2: Verify OTP -->
<div class="otp-card" style="border-color:rgba(5,150,105,.4);background:rgba(5,150,105,.04);">
  <h3>✅ Step 2 — Enter Verification Code</h3>
  <p style="font-size:12px;color:var(--muted);margin:0 0 16px;">Once the recipient shares the 6-digit code, enter it below to verify their wallet ownership.</p>
  <div class="otp-grid" style="margin-bottom:14px;">
    <div class="otp-field">
      <label>OTP ID (from Step 1)</label>
      <input class="otp-input" id="verifyOtpId" placeholder="Paste OTP ID from above" />
    </div>
    <div class="otp-field">
      <label>6-Digit OTP Code *</label>
      <input class="otp-input" id="verifyCode" placeholder="e.g. 483920" maxlength="6" style="font-size:20px;font-weight:700;letter-spacing:4px;text-align:center;" />
    </div>
  </div>
  <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;">
    <button class="otp-btn success" onclick="verifyOtp()" id="verifyBtn">🔓 Verify Wallet</button>
    <span id="verifyStatus" style="font-size:12px;color:var(--muted);"></span>
  </div>
  <div id="verifiedBox" style="display:none;margin-top:14px;padding:16px 18px;background:rgba(5,150,105,.1);border:1px solid rgba(5,150,105,.4);border-radius:8px;">
    <p style="font-size:14px;font-weight:800;color:#34d399;margin:0 0 8px;">🎉 Wallet Verified Successfully!</p>
    <div id="verifiedDetails" style="font-size:12px;color:var(--muted);line-height:1.9;"></div>
  </div>
</div>
...
<div class="otp-card">
  <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;">
    <h3 style="margin:0;">📋 Verification Log</h3>
    <div style="display:flex;gap:8px;">
      <label style="display:flex;align-items:center;gap:6px;font-size:12px;color:var(--muted);cursor:pointer;">
        <input type="checkbox" id="verifiedOnly" onchange="loadLog()" /> Verified only
      </label>
      <button class="otp-btn ghost" onclick="loadLog()" style="font-size:11px;padding:5px 12px;">🔄 Refresh</button>
    </div>
  </div>
  <div id="otpLog" style="overflow-x:auto;">
    <div style="text-align:center;padding:30px;color:var(--muted);font-size:12px;">Loading…</div>
  </div>
</div>
...
function _toast(msg, type) {
  ...
  t.style.background = type==='ok' ? '#059669' : type==='error' ? '#dc2626' : '#1e293b';
  t.textContent = msg;
  document.body.appendChild(t);
...
function sendOtp() {
  var wallet = document.getElementById('reqWallet').value.trim();
  var phone  = document.getElementById('reqPhone').value.trim();
  var notes  = document.getElementById('reqNotes').value.trim();
  if (!wallet || !phone) { _toast('Wallet address and phone number are required', 'error'); return; }
  var btn = document.getElementById('sendBtn');
  btn.disabled = true;
  document.getElementById('sendStatus').textContent = 'Sending…';
  document.getElementById('sentBox').style.display = 'none';
  api('/api/v1/admin/wallet-otp/request', {
    method: 'POST',
    body: JSON.stringify({ wallet_address: wallet, phone_number: phone, notes: notes || null })
  }).then(function(r) {
    btn.disabled = false;
    _lastOtpId = r.otp_id;
    document.getElementById('sendStatus').textContent = r.whatsapp_sent ? '✅ WhatsApp sent' : '⚠️ Created (WhatsApp failed)';
    document.getElementById('sentOtpId').textContent = r.otp_id;
    document.getElementById('sentWallet').textContent = r.wallet_address;
    document.getElementById('sentExpiry').textContent = new Date(r.expires_at).toLocaleTimeString();
    document.getElementById('sentBox').style.display = 'block';
    document.getElementById('verifyOtpId').value = r.otp_id;
    _toast(r.message, r.whatsapp_sent ? 'ok' : 'warn');
    loadLog();
  }).catch(function(e) {
    btn.disabled = false;
...
function verifyOtp() {
  var id   = document.getElementById('verifyOtpId').value.trim() || _lastOtpId;
  var code = document.getElementById('verifyCode').value.trim();
  if (!id)   { _toast('Enter OTP ID first (from Step 1)', 'error'); return; }
  if (!code) { _toast('Enter the 6-digit OTP code', 'error'); return; }
  var btn = document.getElementById('verifyBtn');
  btn.disabled = true;
  document.getElementById('verifyStatus').textContent = 'Verifying…';
  document.getElementById('verifiedBox').style.display = 'none';
  api('/api/v1/admin/wallet-otp/verify', {
    method: 'POST',
    body: JSON.stringify({ otp_id: id, otp_code: code })
  }).then(function(r) {
    btn.disabled = false;
    document.getElementById('verifyStatus').textContent = '✅ Verified!';
    var d = document.getElementById('verifiedDetails');
    d.innerHTML = '<strong style="color:#f0f0f0;">Wallet:</strong> <code style="color:#34d399;">' + (r.wallet_address||'') + '</code><br>'
                + '<strong style="color:#f0f0f0;">Phone:</strong> ' + (r.phone_number||'') + '<br>'
                + '<strong style="color:#f0f0f0;">Verified at:</strong> ' + (r.verified_at ? new Date(r.verified_at).toLocaleString() : 'Now');
    document.getElementById('verifiedBox').style.display = 'block';
    document.getElementById('verifyCode').value = '';
    _toast('Wallet verified ✅', 'ok');
    loadLog();
  }).catch(function(e) {
    btn.disabled = false;
    document.getElementById('verifyStatus').textContent = '❌ ' + e.message;
    _toast('Verification failed: ' + e.message, 'error');
  });
}

function loadLog() {
  var verifiedOnly = document.getElementById('verifiedOnly').checked;
  var url = '/api/v1/admin/wallet-otp?limit=50' + (verifiedOnly ? '&verified_only=true' : '');
  api(url).then(function(r) {
    var rows = r.records || [];
    if (!rows.length) {
      document.getElementById('otpLog').innerHTML = '<div style="text-align:center;padding:30px;color:var(--muted);font-size:12px;">No records yet</div>';
      return;
    }
    var now = Date.now();
    var html = '<table style="width:100%;border-collapse:collapse;font-size:12px;">'
      + '<thead><tr style="border-bottom:1px solid var(--border);">'
      + '<th style="padding:8px 10px;text-align:left;color:var(--muted);">Wallet</th>'
      + '<th style="padding:8px 10px;text-align:left;color:var(--muted);">Phone</th>'
      + '<th style="padding:8px 10px;text-align:center;color:var(--muted);">Status</th>'
      + '<th style="padding:8px 10px;text-align:left;color:var(--muted);">Notes</th>'
      + '<th style="padding:8px 10px;text-align:left;color:var(--muted);">Created</th>'
      + '<th style="padding:8px 10px;text-align:center;color:var(--muted);">Action</th>'
      + '</tr></thead><tbody>';
    rows.forEach(function(rec) {
      var badge, label;
      if (rec.is_verified) { badge = 'verified'; label = '✅ Verified'; }
      else if (rec.is_expired) { badge = 'expired'; label = '⏱ Expired'; }
      else if (rec.is_used) { badge = 'failed'; label = '❌ Failed'; }
      else { badge = 'pending'; label = '⏳ Pending'; }
      var addr = rec.wallet_address;
      var shortAddr = addr.length > 18 ? addr.slice(0,10)+'…'+addr.slice(-6) : addr;
      var dt = new Date(rec.created_at).toLocaleString();
      html += '<tr style="border-bottom:1px solid rgba(255,255,255,.05);hover:background rgba(255,255,255,.03);">'
        + '<td style="padding:8px 10px;font-family:monospace;font-size:11px;" title="'+addr+'">'+shortAddr+'</td>'
        + '<td style="padding:8px 10px;">'+rec.phone_number+'</td>'
    ...
    html += '</tbody></table>';
    document.getElementById('otpLog').innerHTML = html;
  }).catch(function(e) {
    document.getElementById('otpLog').innerHTML = '<div style="color:#f87171;padding:16px;">Error: '+e.message+'</div>';
  });
}

function delOtp(id) {
  if (!confirm('Delete this OTP record?')) return;
  api('/api/v1/admin/wallet-otp/'+id, { method: 'DELETE' }).then(function() {
    _toast('Deleted', 'ok');
    loadLog();
...
@router.get("/dashboard/wallet-verify", response_class=HTMLResponse)
async def dashboard_wallet_verify(request: Request):
    g = _guard(request)
    if g:
        return g
    return HTMLResponse(_page("🔐 Wallet Verify OTP", "/dashboard/wallet-verify", _WALLET_OTP_BODY))


# ══════════════════════════════════════════════════════════════════════════════
#  CIRCLE WIRE DEPOSITS PAGE
# ══════════════════════════════════════════════════════════════════════════════
...
<div class="panel">
  ...
  <div style="padding:16px;">
    <div class="form-grid">
      <div class="form-field">
        <label>Amount EUR *</label>
        <input type="number" id="cAmtEur" placeholder="e.g. 1000000" min="0" step="0.01">
      </div>
      <div class="form-field">
        <label>Sender Name</label>
        <input type="text" id="cSenderName" placeholder="e.g. CryptohostGMBH">
      </div>
      <div class="form-field">
        <label>Sender Bank</label>
        <input type="text" id="cSenderBank" placeholder="e.g. Deutsche Bank AG">
      </div>
      <div class="form-field">
        <label>Sender IBAN</label>
        <input type="text" id="cSenderIban" placeholder="e.g. DE89370400440532013000">
      </div>
      <div class="form-field">
        <label>Sender SWIFT BIC</label>
        <input type="text" id="cSenderBic" placeholder="e.g. DEUTDEDB">
      </div>
      <div class="form-field">
      ...
      <div class="form-field" style="grid-column:1/-1;">
        <label>Settlement Wallet (leave blank for Master Wallet)</label>
        <input type="text" id="cSettleWallet" placeholder="0x... or TRON address (auto: Master Wallet)">
      </div>
      <div class="form-field" style="grid-column:1/-1;">
        <label>Notes</label>
...
function createWireDeposit() {
  ...
  var body = {
    amount_eur: amt,
    sender_name: document.getElementById('cSenderName').value.trim() || null,
    sender_bank: document.getElementById('cSenderBank').value.trim() || null,
    sender_iban: document.getElementById('cSenderIban').value.trim() || null,
...
function cancelDeposit(id) {
  ...
  api('/api/v1/admin/circle/wire-deposits/' + id + '/cancel', { method: 'POST' }).then(function(d) {
    showToast(d.ok ? 'Cancelled.' : (d.error || 'Error'), d.ok ? 'ok' : 'error');
    loadDeposits(); loadCircleSummary();
  }).catch(function(e) { showToast('Error: ' + e.message, 'error'); });
}
...
@router.get("/dashboard/circle", response_class=HTMLResponse)
async def dashboard_circle(request: Request):
    g = _guard(request)
    if g:
        return g
    return HTMLResponse(_page("🔵 Circle Wire Deposits", "/dashboard/circle", _CIRCLE_BODY))
