...
class PaymentOrder(Base):
    ...
    treasury_wallet_address: Mapped[str | None] = mapped_column(String(128), nullable=True)
    payer_email: Mapped[str | None] = mapped_column(String(255), nullable=True)
    payment_reference: Mapped[str | None] = mapped_column(String(128), index=True, nullable=True)
    tx_hash: Mapped[str | None] = mapped_column(String(128), index=True, nullable=True)
...
class AuditLog(Base):
    ...
    id: Mapped[str] = mapped_column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    order_id: Mapped[str | None] = mapped_column(String(36), ForeignKey("payment_orders.id"))
