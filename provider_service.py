...
All payment creation is routed through here.
"""
...
class ProviderService:
    """Routes payment creation to the correct provider."""
    ...
    async def _create_fiat_payment(
        ...
        amount_cents = int(data.amount * 100)  # Stripe uses cents
