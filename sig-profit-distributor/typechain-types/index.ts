...
export type { SIGProfitDistributor } from "./contracts/SIGProfitDistributor";
export { SIGProfitDistributor__factory } from "./factories/contracts/SIGProfitDistributor__factory";
